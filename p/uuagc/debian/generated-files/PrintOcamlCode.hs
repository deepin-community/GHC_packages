...
-- UUAGC 0.9.40.3 (src-ag/PrintOcamlCode.ag)
...
{-# LINE 15 "dist-ghc/build/PrintOcamlCode.hs" #-}
...
{-# LINE 26 "dist-ghc/build/PrintOcamlCode.hs" #-}
...
{-# LINE 33 "dist-ghc/build/PrintOcamlCode.hs" #-}
...
{-# LINE 50 "dist-ghc/build/PrintOcamlCode.hs" #-}

{-# LINE 174 "src-ag/PrintOcamlCode.ag" #-}

toOcamlTC (c:cs) = toLower c : cs
toOcamlTC xs = xs
{-# LINE 56 "dist-ghc/build/PrintOcamlCode.hs" #-}
...
{-# LINE 75 "dist-ghc/build/PrintOcamlCode.hs" #-}
-- CaseAlt -----------------------------------------------------
{-
   visit 0:
      inherited attribute:
...
sem_CaseAlt_CaseAlt !(T_Lhs left_) !(T_Expr expr_) =
    (T_CaseAlt (\ (!_lhsIoptions) ->
                    (case (({-# LINE 43 "src-ag/PrintOcamlCode.ag" #-}
                            _lhsIoptions
                            {-# LINE 111 "dist-ghc/build/PrintOcamlCode" #-}
                            )) of
                     { !_exprOoptions ->
                     (case (expr_ _exprOoptions) of
                      { ( !_exprIpp) ->
                          (case (({-# LINE 43 "src-ag/PrintOcamlCode.ag" #-}
                                  _lhsIoptions
                                  {-# LINE 118 "dist-ghc/build/PrintOcamlCode" #-}
                                  )) of
                           { !_leftOoptions ->
                           (case (left_ _leftOoptions) of
                            { ( !_leftIpp) ->
                                (case (({-# LINE 180 "src-ag/PrintOcamlCode.ag" #-}
                                        _leftIpp >#< "->" >#< _exprIpp
                                        {-# LINE 125 "dist-ghc/build/PrintOcamlCode" #-}
                                        )) of
                                 { !_lhsOpp ->
                                 ( _lhsOpp) }) }) }) }) })))
-- CaseAlts ----------------------------------------------------
...
sem_CaseAlts_Cons !(T_CaseAlt hd_) !(T_CaseAlts tl_) =
    (T_CaseAlts (\ (!_lhsIoptions) ->
                     (case (({-# LINE 43 "src-ag/PrintOcamlCode.ag" #-}
                             _lhsIoptions
                             {-# LINE 165 "dist-ghc/build/PrintOcamlCode" #-}
                             )) of
                      { !_tlOoptions ->
                      (case (tl_ _tlOoptions) of
                       { ( !_tlIpps) ->
                           (case (({-# LINE 43 "src-ag/PrintOcamlCode.ag" #-}
                                   _lhsIoptions
                                   {-# LINE 172 "dist-ghc/build/PrintOcamlCode" #-}
                                   )) of
                            { !_hdOoptions ->
                            (case (hd_ _hdOoptions) of
                             { ( !_hdIpp) ->
                                 (case (({-# LINE 64 "src-ag/PrintOcamlCode.ag" #-}
                                         _hdIpp : _tlIpps
                                         {-# LINE 179 "dist-ghc/build/PrintOcamlCode" #-}
                                         )) of
                                  { !_lhsOpps ->
                                  ( _lhsOpps) }) }) }) }) })))
...
sem_CaseAlts_Nil =
    (T_CaseAlts (\ (!_lhsIoptions) ->
                     (case (({-# LINE 65 "src-ag/PrintOcamlCode.ag" #-}
                             []
                             {-# LINE 188 "dist-ghc/build/PrintOcamlCode" #-}
                             )) of
                      { !_lhsOpps ->
                      ( _lhsOpps) })))
-- Chunk -------------------------------------------------------
    ...
    (T_Chunk (\ (!_lhsIisToplevel)
                ...
                (!_lhsItextBlockMap) ->
                  (case (({-# LINE 209 "src-ag/PrintOcamlCode.ag" #-}
                          _lhsIisToplevel
                          {-# LINE 247 "dist-ghc/build/PrintOcamlCode" #-}
                          )) of
                   { !_semFunctionsOisToplevel ->
                   (case (({-# LINE 209 "src-ag/PrintOcamlCode.ag" #-}
                           _lhsIisToplevel
                           {-# LINE 252 "dist-ghc/build/PrintOcamlCode" #-}
                           )) of
                    { !_semWrapperOisToplevel ->
                    (case (({-# LINE 209 "src-ag/PrintOcamlCode.ag" #-}
                            _lhsIisToplevel
                            {-# LINE 257 "dist-ghc/build/PrintOcamlCode" #-}
                            )) of
                     { !_semDomOisToplevel ->
                     (case (({-# LINE 209 "src-ag/PrintOcamlCode.ag" #-}
                             _lhsIisToplevel
                             {-# LINE 262 "dist-ghc/build/PrintOcamlCode" #-}
                             )) of
                      { !_cataFunOisToplevel ->
                      (case (({-# LINE 209 "src-ag/PrintOcamlCode.ag" #-}
                              _lhsIisToplevel
                              {-# LINE 267 "dist-ghc/build/PrintOcamlCode" #-}
                              )) of
                       { !_dataDefOisToplevel ->
                       (case (({-# LINE 209 "src-ag/PrintOcamlCode.ag" #-}
                               _lhsIisToplevel
                               {-# LINE 272 "dist-ghc/build/PrintOcamlCode" #-}
                               )) of
                        { !_infoOisToplevel ->
                        (case (({-# LINE 209 "src-ag/PrintOcamlCode.ag" #-}
                                _lhsIisToplevel
                                {-# LINE 277 "dist-ghc/build/PrintOcamlCode" #-}
                                )) of
                         { !_commentOisToplevel ->
                         (case (({-# LINE 43 "src-ag/PrintOcamlCode.ag" #-}
                                 _lhsIoptions
                                 {-# LINE 282 "dist-ghc/build/PrintOcamlCode" #-}
                                 )) of
                          ...
                          (case (semFunctions_ _semFunctionsOisToplevel _semFunctionsOoptions) of
                           { ( !_semFunctionsIpps) ->
                               (case (({-# LINE 43 "src-ag/PrintOcamlCode.ag" #-}
                                       _lhsIoptions
                                       {-# LINE 289 "dist-ghc/build/PrintOcamlCode" #-}
                                       )) of
                                { !_semWrapperOoptions ->
                                (case (semWrapper_ _semWrapperOisToplevel _semWrapperOoptions) of
                                 { ( !_semWrapperIpps) ->
                                     (case (({-# LINE 43 "src-ag/PrintOcamlCode.ag" #-}
                                             _lhsIoptions
                                             {-# LINE 296 "dist-ghc/build/PrintOcamlCode" #-}
                                             )) of
                                      { !_semDomOoptions ->
                                      (case (semDom_ _semDomOisToplevel _semDomOoptions) of
                                       { ( !_semDomIpps) ->
                                           (case (({-# LINE 43 "src-ag/PrintOcamlCode.ag" #-}
                                                   _lhsIoptions
                                                   {-# LINE 303 "dist-ghc/build/PrintOcamlCode" #-}
                                                   )) of
                                            { !_cataFunOoptions ->
                                            (case (cataFun_ _cataFunOisToplevel _cataFunOoptions) of
                                             { ( !_cataFunIpps) ->
                                                 (case (({-# LINE 43 "src-ag/PrintOcamlCode.ag" #-}
                                                         _lhsIoptions
                                                         {-# LINE 310 "dist-ghc/build/PrintOcamlCode" #-}
                                                         )) of
                                                  { !_dataDefOoptions ->
                                                  (case (dataDef_ _dataDefOisToplevel _dataDefOoptions) of
                                                   { ( !_dataDefIpps) ->
                                                       (case (({-# LINE 43 "src-ag/PrintOcamlCode.ag" #-}
                                                               _lhsIoptions
                                                               {-# LINE 317 "dist-ghc/build/PrintOcamlCode" #-}
                                                               )) of
                                                        { !_infoOoptions ->
                                                        (case (info_ _infoOisToplevel _infoOoptions) of
                                                         { ( !_infoIpps) ->
                                                             (case (({-# LINE 43 "src-ag/PrintOcamlCode.ag" #-}
                                                                     _lhsIoptions
                                                                     {-# LINE 324 "dist-ghc/build/PrintOcamlCode" #-}
                                                                     )) of
                                                              { !_commentOoptions ->
                                                              (case (comment_ _commentOisToplevel _commentOoptions) of
                                                               { ( !_commentIpp) ->
                                                                   (case (({-# LINE 96 "src-ag/PrintOcamlCode.ag" #-}
                                                                           ...
                                                                           {-# LINE 338 "dist-ghc/build/PrintOcamlCode" #-}
                                                                           )) of
                                                                    { !_lhsOpps ->
                                                                    ( _lhsOpps) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) })))
-- Chunks ------------------------------------------------------
    ...
    (T_Chunks (\ (!_lhsIisToplevel)
                 ...
                 (!_lhsItextBlockMap) ->
                   (case (({-# LINE 45 "src-ag/PrintOcamlCode.ag" #-}
                           _lhsItextBlockMap
                           {-# LINE 384 "dist-ghc/build/PrintOcamlCode" #-}
                           )) of
                    { !_tlOtextBlockMap ->
                    (case (({-# LINE 209 "src-ag/PrintOcamlCode.ag" #-}
                            _lhsIisToplevel
                            {-# LINE 389 "dist-ghc/build/PrintOcamlCode" #-}
                            )) of
                     { !_tlOisToplevel ->
                     (case (({-# LINE 45 "src-ag/PrintOcamlCode.ag" #-}
                             _lhsItextBlockMap
                             {-# LINE 394 "dist-ghc/build/PrintOcamlCode" #-}
                             )) of
                      { !_hdOtextBlockMap ->
                      (case (({-# LINE 209 "src-ag/PrintOcamlCode.ag" #-}
                              _lhsIisToplevel
                              {-# LINE 399 "dist-ghc/build/PrintOcamlCode" #-}
                              )) of
                       { !_hdOisToplevel ->
                       (case (({-# LINE 43 "src-ag/PrintOcamlCode.ag" #-}
                               _lhsIoptions
                               {-# LINE 404 "dist-ghc/build/PrintOcamlCode" #-}
                               )) of
                        { !_tlOoptions ->
                        (case (tl_ _tlOisToplevel _tlOoptions _tlOtextBlockMap) of
                         { ( !_tlIpps) ->
                             (case (({-# LINE 43 "src-ag/PrintOcamlCode.ag" #-}
                                     _lhsIoptions
                                     {-# LINE 411 "dist-ghc/build/PrintOcamlCode" #-}
                                     )) of
                              { !_hdOoptions ->
                              (case (hd_ _hdOisToplevel _hdOoptions _hdOtextBlockMap) of
                               { ( !_hdIpps) ->
                                   (case (({-# LINE 84 "src-ag/PrintOcamlCode.ag" #-}
                                           _hdIpps ++ _tlIpps
                                           {-# LINE 418 "dist-ghc/build/PrintOcamlCode" #-}
                                           )) of
                                    { !_lhsOpps ->
                                    ( _lhsOpps) }) }) }) }) }) }) }) }) })))
    ...
    (T_Chunks (\ (!_lhsIisToplevel)
                 ...
                 (!_lhsItextBlockMap) ->
                   (case (({-# LINE 85 "src-ag/PrintOcamlCode.ag" #-}
                           []
                           {-# LINE 429 "dist-ghc/build/PrintOcamlCode" #-}
                           )) of
                    { !_lhsOpps ->
                    ( _lhsOpps) })))
-- DataAlt -----------------------------------------------------
    ...
    (T_DataAlt (case (args_) of
                { ( !_argsIpps) ->
                    (case (({-# LINE 183 "src-ag/PrintOcamlCode.ag" #-}
                            ...
                            {-# LINE 471 "dist-ghc/build/PrintOcamlCode" #-}
                            )) of
                     { !_lhsOpp ->
                     ( _lhsOpp) }) }))
    ...
    (T_DataAlt (case (args_) of
                { ( !_argsIpps) ->
                    (case (({-# LINE 184 "src-ag/PrintOcamlCode.ag" #-}
                            pp_block "{" "}" ";" _argsIpps
                            {-# LINE 483 "dist-ghc/build/PrintOcamlCode" #-}
                            )) of
                     { !_lhsOpp ->
                     ( _lhsOpp) }) }))
-- DataAlts ----------------------------------------------------
                     ...
                     (case (hd_) of
                      { ( !_hdIpp) ->
                          (case (({-# LINE 68 "src-ag/PrintOcamlCode.ag" #-}
                                  _hdIpp : _tlIpps
                                  {-# LINE 523 "dist-ghc/build/PrintOcamlCode" #-}
                                  )) of
                           { !_lhsOpps ->
                           ( _lhsOpps) }) }) }))
...
sem_DataAlts_Nil =
    (T_DataAlts (case (({-# LINE 69 "src-ag/PrintOcamlCode.ag" #-}
                        []
                        {-# LINE 531 "dist-ghc/build/PrintOcamlCode" #-}
                        )) of
                 { !_lhsOpps ->
                 ( _lhsOpps) }))
-- Decl --------------------------------------------------------
    ...
    (T_Decl (\ (!_lhsIisToplevel)
               (!_lhsIoptions) ->
                 (case (({-# LINE 111 "src-ag/PrintOcamlCode.ag" #-}
                         ...
                         {-# LINE 632 "dist-ghc/build/PrintOcamlCode" #-}
                         )) of
                  { !_lhsOpp ->
                  ( _lhsOpp) })))
    ...
    (T_Decl (\ (!_lhsIisToplevel)
               (!_lhsIoptions) ->
                 (case (({-# LINE 112 "src-ag/PrintOcamlCode.ag" #-}
                         ...
                         {-# LINE 644 "dist-ghc/build/PrintOcamlCode" #-}
                         )) of
                  { !_lhsOpp ->
                  ( _lhsOpp) })))
    ...
    (T_Decl (\ (!_lhsIisToplevel)
               (!_lhsIoptions) ->
                 (case (({-# LINE 123 "src-ag/PrintOcamlCode.ag" #-}
                         ...
                         {-# LINE 657 "dist-ghc/build/PrintOcamlCode" #-}
                         )) of
                  { !_lhsOpp ->
                  ( _lhsOpp) })))
                 ...
                 (case (alts_) of
                  { ( !_altsIpps) ->
                      (case (({-# LINE 113 "src-ag/PrintOcamlCode.ag" #-}
                              ...
                              >#< ";;"
                              {-# LINE 680 "dist-ghc/build/PrintOcamlCode" #-}
                              )) of
                       { !_lhsOpp ->
                       ( _lhsOpp) }) })))
sem_Decl_Decl :: T_Lhs ->
...
sem_Decl_Decl !(T_Lhs left_) !(T_Expr rhs_) !binds_ !uses_ =
    (T_Decl (\ (!_lhsIisToplevel)
               (!_lhsIoptions) ->
                 (case (({-# LINE 43 "src-ag/PrintOcamlCode.ag" #-}
                         _lhsIoptions
                         {-# LINE 694 "dist-ghc/build/PrintOcamlCode" #-}
                         )) of
                  { !_rhsOoptions ->
                  (case (rhs_ _rhsOoptions) of
                   { ( !_rhsIpp) ->
                       (case (({-# LINE 43 "src-ag/PrintOcamlCode.ag" #-}
                               _lhsIoptions
                               {-# LINE 701 "dist-ghc/build/PrintOcamlCode" #-}
                               )) of
                        { !_leftOoptions ->
                        (case (left_ _leftOoptions) of
                         { ( !_leftIpp) ->
                             (case (({-# LINE 106 "src-ag/PrintOcamlCode.ag" #-}
                                     ...
                                     then "let" >#< _leftIpp >#< "="
                                          ...
                                          >-< indent 4 _rhsIpp >#< "in"
                                     {-# LINE 712 "dist-ghc/build/PrintOcamlCode" #-}
                                     )) of
                              { !_lhsOpp ->
                              ( _lhsOpp) }) }) }) }) })))
...
sem_Decl_EvalDecl !nt_ !(T_Lhs left_) !(T_Expr rhs_) =
    (T_Decl (\ (!_lhsIisToplevel)
               (!_lhsIoptions) ->
                 (case (({-# LINE 43 "src-ag/PrintOcamlCode.ag" #-}
                         _lhsIoptions
                         {-# LINE 725 "dist-ghc/build/PrintOcamlCode" #-}
                         )) of
                  { !_rhsOoptions ->
                  (case (rhs_ _rhsOoptions) of
                   { ( !_rhsIpp) ->
                       (case (({-# LINE 53 "src-ag/PrintOcamlCode.ag" #-}
                               _rhsIpp
                               {-# LINE 732 "dist-ghc/build/PrintOcamlCode" #-}
                               )) of
                        { !_lhsOpp ->
                        ( _lhsOpp) }) }) })))
    ...
    (T_Decl (\ (!_lhsIisToplevel)
               (!_lhsIoptions) ->
                 (case (({-# LINE 120 "src-ag/PrintOcamlCode.ag" #-}
                         ...
                         {-# LINE 746 "dist-ghc/build/PrintOcamlCode" #-}
                         )) of
                  { !_lhsOpp ->
                  ( _lhsOpp) })))
    ...
    (T_Decl (\ (!_lhsIisToplevel)
               (!_lhsIoptions) ->
                 (case (({-# LINE 126 "src-ag/PrintOcamlCode.ag" #-}
                         ...
                         {-# LINE 757 "dist-ghc/build/PrintOcamlCode" #-}
                         )) of
                  { !_lhsOpp ->
                  ( _lhsOpp) })))
...
sem_Decl_Resume !monadic_ !nt_ !(T_Lhs left_) !(T_Expr rhs_) =
    (T_Decl (\ (!_lhsIisToplevel)
               (!_lhsIoptions) ->
                 (case (({-# LINE 43 "src-ag/PrintOcamlCode.ag" #-}
                         _lhsIoptions
                         {-# LINE 771 "dist-ghc/build/PrintOcamlCode" #-}
                         )) of
                  { !_rhsOoptions ->
                  (case (rhs_ _rhsOoptions) of
                   { ( !_rhsIpp) ->
                       (case (({-# LINE 53 "src-ag/PrintOcamlCode.ag" #-}
                               _rhsIpp
                               {-# LINE 778 "dist-ghc/build/PrintOcamlCode" #-}
                               )) of
                        { !_lhsOpp ->
                        ( _lhsOpp) }) }) })))
                 ...
                 (case (tp_) of
                  { ( !_tpIpp) ->
                      (case (({-# LINE 122 "src-ag/PrintOcamlCode.ag" #-}
                              "(*" >#< name_ >#< ":" >#< _tpIpp >#< "*)"
                              {-# LINE 792 "dist-ghc/build/PrintOcamlCode" #-}
                              )) of
                       { !_lhsOpp ->
                       ( _lhsOpp) }) })))
                 ...
                 (case (tp_) of
                  { ( !_tpIpp) ->
                      (case (({-# LINE 121 "src-ag/PrintOcamlCode.ag" #-}
                              ...
                              {-# LINE 807 "dist-ghc/build/PrintOcamlCode" #-}
                              )) of
                       { !_lhsOpp ->
                       ( _lhsOpp) }) })))
-- Decls -------------------------------------------------------
...
sem_Decls_Cons !(T_Decl hd_) !(T_Decls tl_) =
    (T_Decls (\ (!_lhsIisToplevel)
                (!_lhsIoptions) ->
                  (case (({-# LINE 209 "src-ag/PrintOcamlCode.ag" #-}
                          _lhsIisToplevel
                          {-# LINE 850 "dist-ghc/build/PrintOcamlCode" #-}
                          )) of
                   { !_tlOisToplevel ->
                   (case (({-# LINE 209 "src-ag/PrintOcamlCode.ag" #-}
                           _lhsIisToplevel
                           {-# LINE 855 "dist-ghc/build/PrintOcamlCode" #-}
                           )) of
                    { !_hdOisToplevel ->
                    (case (({-# LINE 43 "src-ag/PrintOcamlCode.ag" #-}
                            _lhsIoptions
                            {-# LINE 860 "dist-ghc/build/PrintOcamlCode" #-}
                            )) of
                     { !_tlOoptions ->
                     (case (tl_ _tlOisToplevel _tlOoptions) of
                      { ( !_tlIpps) ->
                          (case (({-# LINE 43 "src-ag/PrintOcamlCode.ag" #-}
                                  _lhsIoptions
                                  {-# LINE 867 "dist-ghc/build/PrintOcamlCode" #-}
                                  )) of
                           { !_hdOoptions ->
                           (case (hd_ _hdOisToplevel _hdOoptions) of
                            { ( !_hdIpp) ->
                                (case (({-# LINE 80 "src-ag/PrintOcamlCode.ag" #-}
                                        _hdIpp : _tlIpps
                                        {-# LINE 874 "dist-ghc/build/PrintOcamlCode" #-}
                                        )) of
                                 { !_lhsOpps ->
                                 ( _lhsOpps) }) }) }) }) }) }) })))
    ...
    (T_Decls (\ (!_lhsIisToplevel)
                (!_lhsIoptions) ->
                  (case (({-# LINE 81 "src-ag/PrintOcamlCode.ag" #-}
                          []
                          {-# LINE 884 "dist-ghc/build/PrintOcamlCode" #-}
                          )) of
                   { !_lhsOpps ->
                   ( _lhsOpps) })))
-- Expr --------------------------------------------------------
...
sem_Expr_App !name_ !(T_Exprs args_) =
    (T_Expr (\ (!_lhsIoptions) ->
                 (case (({-# LINE 43 "src-ag/PrintOcamlCode.ag" #-}
                         _lhsIoptions
                         {-# LINE 1004 "dist-ghc/build/PrintOcamlCode" #-}
                         )) of
                  { !_argsOoptions ->
                  (case (args_ _argsOoptions) of
                   { ( !_argsIpps) ->
                       (case (({-# LINE 143 "src-ag/PrintOcamlCode.ag" #-}
                               ...
                               {-# LINE 1011 "dist-ghc/build/PrintOcamlCode" #-}
                               )) of
                        { !_lhsOpp ->
                        ( _lhsOpp) }) }) })))
...
sem_Expr_Case !(T_Expr expr_) !(T_CaseAlts alts_) =
    (T_Expr (\ (!_lhsIoptions) ->
                 (case (({-# LINE 43 "src-ag/PrintOcamlCode.ag" #-}
                         _lhsIoptions
                         {-# LINE 1022 "dist-ghc/build/PrintOcamlCode" #-}
                         )) of
                  { !_altsOoptions ->
                  (case (alts_ _altsOoptions) of
                   { ( !_altsIpps) ->
                       (case (({-# LINE 43 "src-ag/PrintOcamlCode.ag" #-}
                               _lhsIoptions
                               {-# LINE 1029 "dist-ghc/build/PrintOcamlCode" #-}
                               )) of
                        { !_exprOoptions ->
                        (case (expr_ _exprOoptions) of
                         { ( !_exprIpp) ->
                             (case (({-# LINE 131 "src-ag/PrintOcamlCode.ag" #-}
                                     ...
                                     {-# LINE 1042 "dist-ghc/build/PrintOcamlCode" #-}
                                     )) of
                              { !_lhsOpp ->
                              ( _lhsOpp) }) }) }) }) })))
sem_Expr_Do :: T_Decls ->
...
sem_Expr_Do !(T_Decls stmts_) !(T_Expr body_) =
    (T_Expr (\ (!_lhsIoptions) ->
                 (case (({-# LINE 138 "src-ag/PrintOcamlCode.ag" #-}
                         ...
                         {-# LINE 1053 "dist-ghc/build/PrintOcamlCode" #-}
                         )) of
                  { !_lhsOpp ->
                  ( _lhsOpp) })))
...
sem_Expr_InvokeExpr !nt_ !(T_Expr expr_) !(T_Exprs args_) =
    (T_Expr (\ (!_lhsIoptions) ->
                 (case (({-# LINE 43 "src-ag/PrintOcamlCode.ag" #-}
                         _lhsIoptions
                         {-# LINE 1065 "dist-ghc/build/PrintOcamlCode" #-}
                         )) of
                  { !_exprOoptions ->
                  (case (expr_ _exprOoptions) of
                   { ( !_exprIpp) ->
                       (case (({-# LINE 53 "src-ag/PrintOcamlCode.ag" #-}
                               _exprIpp
                               {-# LINE 1072 "dist-ghc/build/PrintOcamlCode" #-}
                               )) of
                        { !_lhsOpp ->
                        ( _lhsOpp) }) }) })))
...
sem_Expr_Lambda !(T_Exprs args_) !(T_Expr body_) =
    (T_Expr (\ (!_lhsIoptions) ->
                 (case (({-# LINE 43 "src-ag/PrintOcamlCode.ag" #-}
                         _lhsIoptions
                         {-# LINE 1083 "dist-ghc/build/PrintOcamlCode" #-}
                         )) of
                  { !_bodyOoptions ->
                  (case (body_ _bodyOoptions) of
                   { ( !_bodyIpp) ->
                       (case (({-# LINE 43 "src-ag/PrintOcamlCode.ag" #-}
                               _lhsIoptions
                               {-# LINE 1090 "dist-ghc/build/PrintOcamlCode" #-}
                               )) of
                        { !_argsOoptions ->
                        (case (args_ _argsOoptions) of
                         { ( !_argsIpps) ->
                             (case (({-# LINE 139 "src-ag/PrintOcamlCode.ag" #-}
                                     pp_parens ( pp "fun" >#< hv_sp _argsIpps >#< "->"
                                               >-< indent 2 _bodyIpp )
                                     {-# LINE 1098 "dist-ghc/build/PrintOcamlCode" #-}
                                     )) of
                              { !_lhsOpp ->
                              ( _lhsOpp) }) }) }) }) })))
...
sem_Expr_Let !(T_Decls decls_) !(T_Expr body_) =
    (T_Expr (\ (!_lhsIoptions) ->
                 (case (({-# LINE 216 "src-ag/PrintOcamlCode.ag" #-}
                         False
                         {-# LINE 1109 "dist-ghc/build/PrintOcamlCode" #-}
                         )) of
                  { !_declsOisToplevel ->
                  (case (({-# LINE 43 "src-ag/PrintOcamlCode.ag" #-}
                          _lhsIoptions
                          {-# LINE 1114 "dist-ghc/build/PrintOcamlCode" #-}
                          )) of
                   { !_bodyOoptions ->
                   (case (body_ _bodyOoptions) of
                    { ( !_bodyIpp) ->
                        (case (({-# LINE 43 "src-ag/PrintOcamlCode.ag" #-}
                                _lhsIoptions
                                {-# LINE 1121 "dist-ghc/build/PrintOcamlCode" #-}
                                )) of
                         { !_declsOoptions ->
                         (case (decls_ _declsOisToplevel _declsOoptions) of
                          { ( !_declsIpps) ->
                              (case (({-# LINE 130 "src-ag/PrintOcamlCode.ag" #-}
                                      ...
                                      {-# LINE 1128 "dist-ghc/build/PrintOcamlCode" #-}
                                      )) of
                               { !_lhsOpp ->
                               ( _lhsOpp) }) }) }) }) }) })))
...
sem_Expr_LineExpr !(T_Expr expr_) =
    (T_Expr (\ (!_lhsIoptions) ->
                 (case (({-# LINE 43 "src-ag/PrintOcamlCode.ag" #-}
                         _lhsIoptions
                         {-# LINE 1138 "dist-ghc/build/PrintOcamlCode" #-}
                         )) of
                  { !_exprOoptions ->
                  (case (expr_ _exprOoptions) of
                   { ( !_exprIpp) ->
                       (case (({-# LINE 148 "src-ag/PrintOcamlCode.ag" #-}
                               _exprIpp
                               {-# LINE 1145 "dist-ghc/build/PrintOcamlCode" #-}
                               )) of
                        { !_lhsOpp ->
                        ( _lhsOpp) }) }) })))
...
sem_Expr_PragmaExpr !onLeftSide_ !onNewLine_ !txt_ !(T_Expr expr_) =
    (T_Expr (\ (!_lhsIoptions) ->
                 (case (({-# LINE 43 "src-ag/PrintOcamlCode.ag" #-}
                         _lhsIoptions
                         {-# LINE 1158 "dist-ghc/build/PrintOcamlCode" #-}
                         )) of
                  { !_exprOoptions ->
                  (case (expr_ _exprOoptions) of
                   { ( !_exprIpp) ->
                       (case (({-# LINE 147 "src-ag/PrintOcamlCode.ag" #-}
                               _exprIpp
                               {-# LINE 1165 "dist-ghc/build/PrintOcamlCode" #-}
                               )) of
                        { !_lhsOpp ->
                        ( _lhsOpp) }) }) })))
...
sem_Expr_ResultExpr !nt_ !(T_Expr expr_) =
    (T_Expr (\ (!_lhsIoptions) ->
                 (case (({-# LINE 43 "src-ag/PrintOcamlCode.ag" #-}
                         _lhsIoptions
                         {-# LINE 1176 "dist-ghc/build/PrintOcamlCode" #-}
                         )) of
                  { !_exprOoptions ->
                  (case (expr_ _exprOoptions) of
                   { ( !_exprIpp) ->
                       (case (({-# LINE 53 "src-ag/PrintOcamlCode.ag" #-}
                               _exprIpp
                               {-# LINE 1183 "dist-ghc/build/PrintOcamlCode" #-}
                               )) of
                        { !_lhsOpp ->
                        ( _lhsOpp) }) }) })))
...
sem_Expr_ResumeExpr !nt_ !(T_Expr expr_) !(T_Lhs left_) !(T_Expr rhs_) =
    (T_Expr (\ (!_lhsIoptions) ->
                 (case (({-# LINE 43 "src-ag/PrintOcamlCode.ag" #-}
                         _lhsIoptions
                         {-# LINE 1196 "dist-ghc/build/PrintOcamlCode" #-}
                         )) of
                  { !_rhsOoptions ->
                  (case (rhs_ _rhsOoptions) of
                   { ( !_rhsIpp) ->
                       (case (({-# LINE 53 "src-ag/PrintOcamlCode.ag" #-}
                               _rhsIpp
                               {-# LINE 1203 "dist-ghc/build/PrintOcamlCode" #-}
                               )) of
                        { !_lhsOpp ->
                        ( _lhsOpp) }) }) })))
...
sem_Expr_SemFun !nt_ !(T_Exprs args_) !(T_Expr body_) =
    (T_Expr (\ (!_lhsIoptions) ->
                 (case (({-# LINE 43 "src-ag/PrintOcamlCode.ag" #-}
                         _lhsIoptions
                         {-# LINE 1215 "dist-ghc/build/PrintOcamlCode" #-}
                         )) of
                  { !_bodyOoptions ->
                  (case (body_ _bodyOoptions) of
                   { ( !_bodyIpp) ->
                       (case (({-# LINE 53 "src-ag/PrintOcamlCode.ag" #-}
                               _bodyIpp
                               {-# LINE 1222 "dist-ghc/build/PrintOcamlCode" #-}
                               )) of
                        { !_lhsOpp ->
                        ( _lhsOpp) }) }) })))
...
sem_Expr_SimpleExpr !txt_ =
    (T_Expr (\ (!_lhsIoptions) ->
                 (case (({-# LINE 144 "src-ag/PrintOcamlCode.ag" #-}
                         text txt_
                         {-# LINE 1232 "dist-ghc/build/PrintOcamlCode" #-}
                         )) of
                  { !_lhsOpp ->
                  ( _lhsOpp) })))
...
sem_Expr_TextExpr !lns_ =
    (T_Expr (\ (!_lhsIoptions) ->
                 (case (({-# LINE 145 "src-ag/PrintOcamlCode.ag" #-}
                         vlist (map text lns_)
                         {-# LINE 1242 "dist-ghc/build/PrintOcamlCode" #-}
                         )) of
                  { !_lhsOpp ->
                  ( _lhsOpp) })))
...
sem_Expr_Trace !txt_ !(T_Expr expr_) =
    (T_Expr (\ (!_lhsIoptions) ->
                 (case (({-# LINE 43 "src-ag/PrintOcamlCode.ag" #-}
                         _lhsIoptions
                         {-# LINE 1253 "dist-ghc/build/PrintOcamlCode" #-}
                         )) of
                  { !_exprOoptions ->
                  (case (expr_ _exprOoptions) of
                   { ( !_exprIpp) ->
                       (case (({-# LINE 146 "src-ag/PrintOcamlCode.ag" #-}
                               _exprIpp
                               {-# LINE 1260 "dist-ghc/build/PrintOcamlCode" #-}
                               )) of
                        { !_lhsOpp ->
                        ( _lhsOpp) }) }) })))
...
sem_Expr_TupleExpr !(T_Exprs exprs_) =
    (T_Expr (\ (!_lhsIoptions) ->
                 (case (({-# LINE 43 "src-ag/PrintOcamlCode.ag" #-}
                         _lhsIoptions
                         {-# LINE 1270 "dist-ghc/build/PrintOcamlCode" #-}
                         )) of
                  { !_exprsOoptions ->
                  (case (exprs_ _exprsOoptions) of
                   { ( !_exprsIpps) ->
                       (case (({-# LINE 141 "src-ag/PrintOcamlCode.ag" #-}
                               ...
                               {-# LINE 1277 "dist-ghc/build/PrintOcamlCode" #-}
                               )) of
                        { !_lhsOpp ->
                        ( _lhsOpp) }) }) })))
...
sem_Expr_TypedExpr !(T_Expr expr_) !(T_Type tp_) =
    (T_Expr (\ (!_lhsIoptions) ->
                 (case (({-# LINE 43 "src-ag/PrintOcamlCode.ag" #-}
                         _lhsIoptions
                         {-# LINE 1288 "dist-ghc/build/PrintOcamlCode" #-}
                         )) of
                  { !_exprOoptions ->
                  (case (expr_ _exprOoptions) of
                   { ( !_exprIpp) ->
                       (case (({-# LINE 149 "src-ag/PrintOcamlCode.ag" #-}
                               _exprIpp
                               {-# LINE 1295 "dist-ghc/build/PrintOcamlCode" #-}
                               )) of
                        { !_lhsOpp ->
                        ( _lhsOpp) }) }) })))
...
sem_Expr_UnboxedTupleExpr !(T_Exprs exprs_) =
    (T_Expr (\ (!_lhsIoptions) ->
                 (case (({-# LINE 142 "src-ag/PrintOcamlCode.ag" #-}
                         ...
                         {-# LINE 1305 "dist-ghc/build/PrintOcamlCode" #-}
                         )) of
                  { !_lhsOpp ->
                  ( _lhsOpp) })))
-- Exprs -------------------------------------------------------
...
sem_Exprs_Cons !(T_Expr hd_) !(T_Exprs tl_) =
    (T_Exprs (\ (!_lhsIoptions) ->
                  (case (({-# LINE 43 "src-ag/PrintOcamlCode.ag" #-}
                          _lhsIoptions
                          {-# LINE 1345 "dist-ghc/build/PrintOcamlCode" #-}
                          )) of
                   { !_tlOoptions ->
                   (case (tl_ _tlOoptions) of
                    { ( !_tlIpps) ->
                        (case (({-# LINE 43 "src-ag/PrintOcamlCode.ag" #-}
                                _lhsIoptions
                                {-# LINE 1352 "dist-ghc/build/PrintOcamlCode" #-}
                                )) of
                         { !_hdOoptions ->
                         (case (hd_ _hdOoptions) of
                          { ( !_hdIpp) ->
                              (case (({-# LINE 60 "src-ag/PrintOcamlCode.ag" #-}
                                      _hdIpp : _tlIpps
                                      {-# LINE 1359 "dist-ghc/build/PrintOcamlCode" #-}
                                      )) of
                               { !_lhsOpps ->
                               ( _lhsOpps) }) }) }) }) })))
...
sem_Exprs_Nil =
    (T_Exprs (\ (!_lhsIoptions) ->
                  (case (({-# LINE 61 "src-ag/PrintOcamlCode.ag" #-}
                          []
                          {-# LINE 1368 "dist-ghc/build/PrintOcamlCode" #-}
                          )) of
                   { !_lhsOpps ->
                   ( _lhsOpps) })))
-- Lhs ---------------------------------------------------------
...
sem_Lhs_Fun !name_ !(T_Exprs args_) =
    (T_Lhs (\ (!_lhsIoptions) ->
                (case (({-# LINE 43 "src-ag/PrintOcamlCode.ag" #-}
                        _lhsIoptions
                        {-# LINE 1428 "dist-ghc/build/PrintOcamlCode" #-}
                        )) of
                 { !_argsOoptions ->
                 (case (args_ _argsOoptions) of
                  { ( !_argsIpps) ->
                      (case (({-# LINE 156 "src-ag/PrintOcamlCode.ag" #-}
                              ...
                              {-# LINE 1435 "dist-ghc/build/PrintOcamlCode" #-}
                              )) of
                       { !_lhsOpp ->
                       ( _lhsOpp) }) }) })))
...
sem_Lhs_Pattern3 !(T_Pattern pat3_) =
    (T_Lhs (\ (!_lhsIoptions) ->
                (case (({-# LINE 43 "src-ag/PrintOcamlCode.ag" #-}
                        _lhsIoptions
                        {-# LINE 1445 "dist-ghc/build/PrintOcamlCode" #-}
                        )) of
                 { !_pat3Ooptions ->
                 (case (pat3_ _pat3Ooptions) of
                  { ( !_pat3Icopy,!_pat3IisUnderscore,!_pat3Ipp) ->
                      (case (({-# LINE 152 "src-ag/PrintOcamlCode.ag" #-}
                              _pat3Ipp
                              {-# LINE 1452 "dist-ghc/build/PrintOcamlCode" #-}
                              )) of
                       { !_lhsOpp ->
                       ( _lhsOpp) }) }) })))
...
sem_Lhs_Pattern3SM !(T_Pattern pat3_) =
    (T_Lhs (\ (!_lhsIoptions) ->
                (case (({-# LINE 153 "src-ag/PrintOcamlCode.ag" #-}
                        ...
                        {-# LINE 1462 "dist-ghc/build/PrintOcamlCode" #-}
                        )) of
                 { !_lhsOpp ->
                 ( _lhsOpp) })))
...
sem_Lhs_TupleLhs !comps_ =
    (T_Lhs (\ (!_lhsIoptions) ->
                (case (({-# LINE 154 "src-ag/PrintOcamlCode.ag" #-}
                        ...
                        {-# LINE 1472 "dist-ghc/build/PrintOcamlCode" #-}
                        )) of
                 { !_lhsOpp ->
                 ( _lhsOpp) })))
...
sem_Lhs_UnboxedTupleLhs !comps_ =
    (T_Lhs (\ (!_lhsIoptions) ->
                (case (({-# LINE 155 "src-ag/PrintOcamlCode.ag" #-}
                        ...
                        {-# LINE 1482 "dist-ghc/build/PrintOcamlCode" #-}
                        )) of
                 { !_lhsOpp ->
                 ( _lhsOpp) })))
...
sem_Lhs_Unwrap !name_ !(T_Lhs sub_) =
    (T_Lhs (\ (!_lhsIoptions) ->
                (case (({-# LINE 43 "src-ag/PrintOcamlCode.ag" #-}
                        _lhsIoptions
                        {-# LINE 1493 "dist-ghc/build/PrintOcamlCode" #-}
                        )) of
                 { !_subOoptions ->
                 (case (sub_ _subOoptions) of
                  { ( !_subIpp) ->
                      (case (({-# LINE 157 "src-ag/PrintOcamlCode.ag" #-}
                              ...
                              {-# LINE 1500 "dist-ghc/build/PrintOcamlCode" #-}
                              )) of
                       { !_lhsOpp ->
                       ( _lhsOpp) }) }) })))
-- NamedType ---------------------------------------------------
    ...
    (T_NamedType (case (tp_) of
                  { ( !_tpIpp) ->
                      (case (({-# LINE 187 "src-ag/PrintOcamlCode.ag" #-}
                              name_ >#< ":" >#< _tpIpp
                              {-# LINE 1539 "dist-ghc/build/PrintOcamlCode" #-}
                              )) of
                       { !_lhsOpp ->
                       ( _lhsOpp) }) }))
-- NamedTypes --------------------------------------------------
                       ...
                       (case (hd_) of
                        { ( !_hdIpp) ->
                            (case (({-# LINE 76 "src-ag/PrintOcamlCode.ag" #-}
                                    _hdIpp : _tlIpps
                                    {-# LINE 1579 "dist-ghc/build/PrintOcamlCode" #-}
                                    )) of
                             { !_lhsOpps ->
                             ( _lhsOpps) }) }) }))
...
sem_NamedTypes_Nil =
    (T_NamedTypes (case (({-# LINE 77 "src-ag/PrintOcamlCode.ag" #-}
                          []
                          {-# LINE 1587 "dist-ghc/build/PrintOcamlCode" #-}
                          )) of
                   { !_lhsOpps ->
                   ( _lhsOpps) }))
-- Pattern -----------------------------------------------------
...
sem_Pattern_Alias !field_ !attr_ !(T_Pattern pat_) =
    (T_Pattern (\ (!_lhsIoptions) ->
                    (case (({-# LINE 43 "src-ag/PrintOcamlCode.ag" #-}
                            _lhsIoptions
                            {-# LINE 1658 "dist-ghc/build/PrintOcamlCode" #-}
                            )) of
                     { !_patOoptions ->
                     (case (pat_ _patOoptions) of
                      { ( !_patIcopy,!_patIisUnderscore,!_patIpp) ->
                          (case (({-# LINE 22 "src-ag/Patterns.ag" #-}
                                  ...
                                  {-# LINE 1665 "dist-ghc/build/PrintOcamlCode" #-}
                                  )) of
                           { !_copy ->
                           (case (({-# LINE 22 "src-ag/Patterns.ag" #-}
                                   _copy
                                   {-# LINE 1670 "dist-ghc/build/PrintOcamlCode" #-}
                                   )) of
                            { !_lhsOcopy ->
                            (case (({-# LINE 202 "src-ag/PrintOcamlCode.ag" #-}
                                    False
                                    {-# LINE 1675 "dist-ghc/build/PrintOcamlCode" #-}
                                    )) of
                             { !_lhsOisUnderscore ->
                             (case (({-# LINE 193 "src-ag/PrintOcamlCode.ag" #-}
                                     ...
                                     {-# LINE 1682 "dist-ghc/build/PrintOcamlCode" #-}
                                     )) of
                              { !_lhsOpp ->
...
sem_Pattern_Constr !name_ !(T_Patterns pats_) =
    (T_Pattern (\ (!_lhsIoptions) ->
                    (case (({-# LINE 43 "src-ag/PrintOcamlCode.ag" #-}
                            _lhsIoptions
                            {-# LINE 1693 "dist-ghc/build/PrintOcamlCode" #-}
                            )) of
                     { !_patsOoptions ->
                     (case (pats_ _patsOoptions) of
                      { ( !_patsIcopy,!_patsIpps) ->
                          (case (({-# LINE 22 "src-ag/Patterns.ag" #-}
                                  ...
                                  {-# LINE 1700 "dist-ghc/build/PrintOcamlCode" #-}
                                  )) of
                           { !_copy ->
                           (case (({-# LINE 22 "src-ag/Patterns.ag" #-}
                                   _copy
                                   {-# LINE 1705 "dist-ghc/build/PrintOcamlCode" #-}
                                   )) of
                            { !_lhsOcopy ->
                            (case (({-# LINE 200 "src-ag/PrintOcamlCode.ag" #-}
                                    False
                                    {-# LINE 1710 "dist-ghc/build/PrintOcamlCode" #-}
                                    )) of
                             { !_lhsOisUnderscore ->
                             (case (({-# LINE 190 "src-ag/PrintOcamlCode.ag" #-}
                                     pp_parens $ name_ >#< hv_sp _patsIpps
                                     {-# LINE 1715 "dist-ghc/build/PrintOcamlCode" #-}
                                     )) of
                              { !_lhsOpp ->
                              ( _lhsOcopy,_lhsOisUnderscore,_lhsOpp) }) }) }) }) }) })))
...
sem_Pattern_Irrefutable !(T_Pattern pat_) =
    (T_Pattern (\ (!_lhsIoptions) ->
                    (case (({-# LINE 43 "src-ag/PrintOcamlCode.ag" #-}
                            _lhsIoptions
                            {-# LINE 1725 "dist-ghc/build/PrintOcamlCode" #-}
                            )) of
                     { !_patOoptions ->
                     (case (pat_ _patOoptions) of
                      { ( !_patIcopy,!_patIisUnderscore,!_patIpp) ->
                          (case (({-# LINE 22 "src-ag/Patterns.ag" #-}
                                  ...
                                  {-# LINE 1732 "dist-ghc/build/PrintOcamlCode" #-}
                                  )) of
                           { !_copy ->
                           (case (({-# LINE 22 "src-ag/Patterns.ag" #-}
                                   _copy
                                   {-# LINE 1737 "dist-ghc/build/PrintOcamlCode" #-}
                                   )) of
                            { !_lhsOcopy ->
                            (case (({-# LINE 199 "src-ag/PrintOcamlCode.ag" #-}
                                    _patIisUnderscore
                                    {-# LINE 1742 "dist-ghc/build/PrintOcamlCode" #-}
                                    )) of
                             { !_lhsOisUnderscore ->
                             (case (({-# LINE 196 "src-ag/PrintOcamlCode.ag" #-}
                                     error "pp of Pattern.Irrefutable not supported"
                                     {-# LINE 1747 "dist-ghc/build/PrintOcamlCode" #-}
                                     )) of
                              { !_lhsOpp ->
                              ( _lhsOcopy,_lhsOisUnderscore,_lhsOpp) }) }) }) }) }) })))
...
sem_Pattern_Product !pos_ !(T_Patterns pats_) =
    (T_Pattern (\ (!_lhsIoptions) ->
                    (case (({-# LINE 43 "src-ag/PrintOcamlCode.ag" #-}
                            _lhsIoptions
                            {-# LINE 1758 "dist-ghc/build/PrintOcamlCode" #-}
                            )) of
                     { !_patsOoptions ->
                     (case (pats_ _patsOoptions) of
                      { ( !_patsIcopy,!_patsIpps) ->
                          (case (({-# LINE 22 "src-ag/Patterns.ag" #-}
                                  ...
                                  {-# LINE 1765 "dist-ghc/build/PrintOcamlCode" #-}
                                  )) of
                           { !_copy ->
                           (case (({-# LINE 22 "src-ag/Patterns.ag" #-}
                                   _copy
                                   {-# LINE 1770 "dist-ghc/build/PrintOcamlCode" #-}
                                   )) of
                            { !_lhsOcopy ->
                            (case (({-# LINE 201 "src-ag/PrintOcamlCode.ag" #-}
                                    False
                                    {-# LINE 1775 "dist-ghc/build/PrintOcamlCode" #-}
                                    )) of
                             { !_lhsOisUnderscore ->
                             (case (({-# LINE 191 "src-ag/PrintOcamlCode.ag" #-}
                                     pp_block "(" ")" "," _patsIpps
                                     {-# LINE 1780 "dist-ghc/build/PrintOcamlCode" #-}
                                     )) of
                              { !_lhsOpp ->
                              ( _lhsOcopy,_lhsOisUnderscore,_lhsOpp) }) }) }) }) }) })))
...
sem_Pattern_Underscore !pos_ =
    (T_Pattern (\ (!_lhsIoptions) ->
                    (case (({-# LINE 22 "src-ag/Patterns.ag" #-}
                            Underscore pos_
                            {-# LINE 1790 "dist-ghc/build/PrintOcamlCode" #-}
                            )) of
                     { !_copy ->
                     (case (({-# LINE 22 "src-ag/Patterns.ag" #-}
                             _copy
                             {-# LINE 1795 "dist-ghc/build/PrintOcamlCode" #-}
                             )) of
                      { !_lhsOcopy ->
                      (case (({-# LINE 203 "src-ag/PrintOcamlCode.ag" #-}
                              True
                              {-# LINE 1800 "dist-ghc/build/PrintOcamlCode" #-}
                              )) of
                       { !_lhsOisUnderscore ->
                       (case (({-# LINE 197 "src-ag/PrintOcamlCode.ag" #-}
                               text "_"
                               {-# LINE 1805 "dist-ghc/build/PrintOcamlCode" #-}
                               )) of
                        { !_lhsOpp ->
                        ( _lhsOcopy,_lhsOisUnderscore,_lhsOpp) }) }) }) })))
-- Patterns ----------------------------------------------------
...
sem_Patterns_Cons !(T_Pattern hd_) !(T_Patterns tl_) =
    (T_Patterns (\ (!_lhsIoptions) ->
                     (case (({-# LINE 43 "src-ag/PrintOcamlCode.ag" #-}
                             _lhsIoptions
                             {-# LINE 1850 "dist-ghc/build/PrintOcamlCode" #-}
                             )) of
                      { !_tlOoptions ->
                      (case (tl_ _tlOoptions) of
                       { ( !_tlIcopy,!_tlIpps) ->
                           (case (({-# LINE 43 "src-ag/PrintOcamlCode.ag" #-}
                                   _lhsIoptions
                                   {-# LINE 1857 "dist-ghc/build/PrintOcamlCode" #-}
                                   )) of
                            { !_hdOoptions ->
                            (case (hd_ _hdOoptions) of
                             { ( !_hdIcopy,!_hdIisUnderscore,!_hdIpp) ->
                                 (case (({-# LINE 22 "src-ag/Patterns.ag" #-}
                                         (:) _hdIcopy _tlIcopy
                                         {-# LINE 1864 "dist-ghc/build/PrintOcamlCode" #-}
                                         )) of
                                  { !_copy ->
                                  (case (({-# LINE 22 "src-ag/Patterns.ag" #-}
                                          _copy
                                          {-# LINE 1869 "dist-ghc/build/PrintOcamlCode" #-}
                                          )) of
                                   { !_lhsOcopy ->
                                   (case (({-# LINE 88 "src-ag/PrintOcamlCode.ag" #-}
                                           _hdIpp : _tlIpps
                                           {-# LINE 1874 "dist-ghc/build/PrintOcamlCode" #-}
                                           )) of
                                    { !_lhsOpps ->
                                    ( _lhsOcopy,_lhsOpps) }) }) }) }) }) }) })))
...
sem_Patterns_Nil =
    (T_Patterns (\ (!_lhsIoptions) ->
                     (case (({-# LINE 22 "src-ag/Patterns.ag" #-}
                             []
                             {-# LINE 1883 "dist-ghc/build/PrintOcamlCode" #-}
                             )) of
                      { !_copy ->
                      (case (({-# LINE 22 "src-ag/Patterns.ag" #-}
                              _copy
                              {-# LINE 1888 "dist-ghc/build/PrintOcamlCode" #-}
                              )) of
                       { !_lhsOcopy ->
                       (case (({-# LINE 89 "src-ag/PrintOcamlCode.ag" #-}
                               []
                               {-# LINE 1893 "dist-ghc/build/PrintOcamlCode" #-}
                               )) of
                        { !_lhsOpps ->
                        ( _lhsOcopy,_lhsOpps) }) }) })))
-- Program -----------------------------------------------------
...
sem_Program_Program !(T_Chunks chunks_) !ordered_ =
    (T_Program (\ (!_lhsIoptions)
                  (!_lhsItextBlockMap) ->
                    (case (({-# LINE 45 "src-ag/PrintOcamlCode.ag" #-}
                            _lhsItextBlockMap
                            {-# LINE 1935 "dist-ghc/build/PrintOcamlCode" #-}
                            )) of
                     { !_chunksOtextBlockMap ->
                     (case (({-# LINE 212 "src-ag/PrintOcamlCode.ag" #-}
                             True
                             {-# LINE 1940 "dist-ghc/build/PrintOcamlCode" #-}
                             )) of
                      { !_chunksOisToplevel ->
                      (case (({-# LINE 43 "src-ag/PrintOcamlCode.ag" #-}
                              _lhsIoptions
                              {-# LINE 1945 "dist-ghc/build/PrintOcamlCode" #-}
                              )) of
                       { !_chunksOoptions ->
                       (case (chunks_ _chunksOisToplevel _chunksOoptions _chunksOtextBlockMap) of
                        { ( !_chunksIpps) ->
                            (case (({-# LINE 57 "src-ag/PrintOcamlCode.ag" #-}
                                    _chunksIpps
                                    {-# LINE 1952 "dist-ghc/build/PrintOcamlCode" #-}
                                    )) of
                             { !_lhsOoutput ->
                             ( _lhsOoutput) }) }) }) }) })))
-- Type --------------------------------------------------------
                 ...
                 (case (left_) of
                  { ( !_leftIpp) ->
                      (case (({-# LINE 160 "src-ag/PrintOcamlCode.ag" #-}
                              ...
                              {-# LINE 2046 "dist-ghc/build/PrintOcamlCode" #-}
                              )) of
                       { !_lhsOpp ->
                       ( _lhsOpp) }) }) }))
...
sem_Type_CtxApp !left_ !(T_Type right_) =
    (T_Type (case (({-# LINE 161 "src-ag/PrintOcamlCode.ag" #-}
                    ...
                    {-# LINE 2056 "dist-ghc/build/PrintOcamlCode" #-}
                    )) of
             { !_lhsOpp ->
             ( _lhsOpp) }))
    ...
    (T_Type (case (tp_) of
             { ( !_tpIpp) ->
                 (case (({-# LINE 166 "src-ag/PrintOcamlCode.ag" #-}
                         _tpIpp >#< "list"
                         {-# LINE 2067 "dist-ghc/build/PrintOcamlCode" #-}
                         )) of
                  { !_lhsOpp ->
                  ( _lhsOpp) }) }))
...
sem_Type_NontermType !name_ !params_ !deforested_ =
    (T_Type (case (({-# LINE 168 "src-ag/PrintOcamlCode.ag" #-}
                    ...
                    {-# LINE 2078 "dist-ghc/build/PrintOcamlCode" #-}
                    )) of
             { !_lhsOpp ->
             ( _lhsOpp) }))
...
sem_Type_QuantApp !left_ !(T_Type right_) =
    (T_Type (case (right_) of
             { ( !_rightIpp) ->
                 (case (({-# LINE 53 "src-ag/PrintOcamlCode.ag" #-}
                         _rightIpp
                         {-# LINE 2090 "dist-ghc/build/PrintOcamlCode" #-}
                         )) of
                  { !_lhsOpp ->
                  ( _lhsOpp) }) }))
...
sem_Type_SimpleType !txt_ =
    (T_Type (case (({-# LINE 167 "src-ag/PrintOcamlCode.ag" #-}
                    text txt_
                    {-# LINE 2099 "dist-ghc/build/PrintOcamlCode" #-}
                    )) of
             { !_lhsOpp ->
             ( _lhsOpp) }))
...
sem_Type_TEither !(T_Type left_) !(T_Type right_) =
    (T_Type (case (({-# LINE 170 "src-ag/PrintOcamlCode.ag" #-}
                    ...
                    {-# LINE 2109 "dist-ghc/build/PrintOcamlCode" #-}
                    )) of
             { !_lhsOpp ->
             ( _lhsOpp) }))
...
sem_Type_TIntMap !(T_Type value_) =
    (T_Type (case (({-# LINE 172 "src-ag/PrintOcamlCode.ag" #-}
                    ...
                    {-# LINE 2118 "dist-ghc/build/PrintOcamlCode" #-}
                    )) of
             { !_lhsOpp ->
             ( _lhsOpp) }))
...
sem_Type_TMap !(T_Type key_) !(T_Type value_) =
    (T_Type (case (({-# LINE 171 "src-ag/PrintOcamlCode.ag" #-}
                    ...
                    {-# LINE 2128 "dist-ghc/build/PrintOcamlCode" #-}
                    )) of
             { !_lhsOpp ->
             ( _lhsOpp) }))
    ...
    (T_Type (case (tp_) of
             { ( !_tpIpp) ->
                 (case (({-# LINE 169 "src-ag/PrintOcamlCode.ag" #-}
                         _tpIpp >#< "opt"
                         {-# LINE 2139 "dist-ghc/build/PrintOcamlCode" #-}
                         )) of
                  { !_lhsOpp ->
                  ( _lhsOpp) }) }))
    ...
    (T_Type (case (tps_) of
             { ( !_tpsIpps) ->
                 (case (({-# LINE 163 "src-ag/PrintOcamlCode.ag" #-}
                         pp_block "(" ")" "," _tpsIpps
                         {-# LINE 2150 "dist-ghc/build/PrintOcamlCode" #-}
                         )) of
                  { !_lhsOpp ->
                  ( _lhsOpp) }) }))
                 ...
                 (case (func_) of
                  { ( !_funcIpp) ->
                      (case (({-# LINE 162 "src-ag/PrintOcamlCode.ag" #-}
                              ...
                              {-# LINE 2164 "dist-ghc/build/PrintOcamlCode" #-}
                              )) of
                       { !_lhsOpp ->
                       ( _lhsOpp) }) }) }))
...
sem_Type_UnboxedTupleType !(T_Types tps_) =
    (T_Type (case (({-# LINE 165 "src-ag/PrintOcamlCode.ag" #-}
                    ...
                    {-# LINE 2173 "dist-ghc/build/PrintOcamlCode" #-}
                    )) of
             { !_lhsOpp ->
             ( _lhsOpp) }))
-- Types -------------------------------------------------------
                  ...
                  (case (hd_) of
                   { ( !_hdIpp) ->
                       (case (({-# LINE 72 "src-ag/PrintOcamlCode.ag" #-}
                               _hdIpp : _tlIpps
                               {-# LINE 2213 "dist-ghc/build/PrintOcamlCode" #-}
                               )) of
                        { !_lhsOpps ->
                        ( _lhsOpps) }) }) }))
...
sem_Types_Nil =
    (T_Types (case (({-# LINE 73 "src-ag/PrintOcamlCode.ag" #-}
                     []
                     {-# LINE 2221 "dist-ghc/build/PrintOcamlCode" #-}
                     )) of
              { !_lhsOpps ->
              ( _lhsOpps) }))