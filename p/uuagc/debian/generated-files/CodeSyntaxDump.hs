...
-- UUAGC 0.9.40.3 (src-ag/CodeSyntaxDump.ag)
...
import CodeSyntax
{-# LINE 15 "dist-ghc/build/CodeSyntaxDump.hs" #-}
...
import Data.Map(Map)
import Data.Set(Set)
{-# LINE 23 "dist-ghc/build/CodeSyntaxDump.hs" #-}
...
{-# LINE 30 "dist-ghc/build/CodeSyntaxDump.hs" #-}
...
ppStrings = vlist
{-# LINE 58 "dist-ghc/build/CodeSyntaxDump.hs" #-}
-- CGrammar ----------------------------------------------------
{-
   visit 0:
    ...
    (T_CGrammar (let _lhsOpp :: PP_Doc
                     ...
                     _lhsOpp =
                         ({-# LINE 47 "src-ag/CodeSyntaxDump.ag" #-}
                          ...
                          {-# LINE 117 "dist-ghc/build/CodeSyntaxDump" #-}
                          )
    ...
    (T_CInterface (let _lhsOpp :: PP_Doc
                       ...
                       _lhsOpp =
                           ({-# LINE 57 "src-ag/CodeSyntaxDump.ag" #-}
                            ...
                            {-# LINE 156 "dist-ghc/build/CodeSyntaxDump" #-}
                            )
                       ( _segIpp,_segIppL) =
                           seg_
                   in  ( _lhsOpp)))
    ...
    (T_CNonterminal (let _lhsOpp :: PP_Doc
                         ...
                         _lhsOpp =
                             ({-# LINE 54 "src-ag/CodeSyntaxDump.ag" #-}
                              ...
                              {-# LINE 206 "dist-ghc/build/CodeSyntaxDump" #-}
                              )
    ...
    (T_CNonterminals (let _lhsOppL :: ([PP_Doc])
                          ...
                          _lhsOppL =
                              ({-# LINE 103 "src-ag/CodeSyntaxDump.ag" #-}
                               []
                               {-# LINE 274 "dist-ghc/build/CodeSyntaxDump" #-}
                               )
                          -- use rule "src-ag/CodeSyntaxDump.ag"(line 44, column 40)
                          _lhsOpp =
                              ({-# LINE 44 "src-ag/CodeSyntaxDump.ag" #-}
                               empty
                               {-# LINE 280 "dist-ghc/build/CodeSyntaxDump" #-}
                               )
                      in  ( _lhsOpp,_lhsOppL)))
-- CProduction -------------------------------------------------
{-
    ...
    (T_CProduction (let _lhsOpp :: PP_Doc
                        ...
                        _lhsOpp =
                            ({-# LINE 63 "src-ag/CodeSyntaxDump.ag" #-}
                             ...
                             {-# LINE 323 "dist-ghc/build/CodeSyntaxDump" #-}
                             )
    ...
    (T_CProductions (let _lhsOppL :: ([PP_Doc])
                         ...
                         _lhsOppL =
                             ({-# LINE 94 "src-ag/CodeSyntaxDump.ag" #-}
                              _hdIpp : _tlIppL
                              {-# LINE 368 "dist-ghc/build/CodeSyntaxDump" #-}
                              )
                         -- use rule "src-ag/CodeSyntaxDump.ag"(line 44, column 40)
                         _lhsOpp =
                             ({-# LINE 44 "src-ag/CodeSyntaxDump.ag" #-}
                              _hdIpp >-< _tlIpp
                              {-# LINE 374 "dist-ghc/build/CodeSyntaxDump" #-}
                              )
                         ( _hdIpp) =
                             hd_
                         ( _tlIpp,_tlIppL) =
    ...
    (T_CProductions (let _lhsOppL :: ([PP_Doc])
                         ...
                         _lhsOppL =
                             ({-# LINE 95 "src-ag/CodeSyntaxDump.ag" #-}
                              []
                              {-# LINE 389 "dist-ghc/build/CodeSyntaxDump" #-}
                              )
                         -- use rule "src-ag/CodeSyntaxDump.ag"(line 44, column 40)
                         _lhsOpp =
                             ({-# LINE 44 "src-ag/CodeSyntaxDump.ag" #-}
                              empty
                              {-# LINE 395 "dist-ghc/build/CodeSyntaxDump" #-}
                              )
                     in  ( _lhsOpp,_lhsOppL)))
-- CRule -------------------------------------------------------
{-
    ...
    (T_CRule (let _lhsOpp :: PP_Doc
                  ...
                  _lhsOpp =
                      ({-# LINE 70 "src-ag/CodeSyntaxDump.ag" #-}
                       ...
                       {-# LINE 459 "dist-ghc/build/CodeSyntaxDump" #-}
                       )
              in  ( _lhsOpp)))
    ...
    (T_CRule (let _lhsOpp :: PP_Doc
                  ...
                  _lhsOpp =
                      ({-# LINE 69 "src-ag/CodeSyntaxDump.ag" #-}
                       ...
                       {-# LINE 487 "dist-ghc/build/CodeSyntaxDump" #-}
                       )
    ...
    (T_CSegment (let _lhsOpp :: PP_Doc
                     ...
                     _lhsOpp =
                         ({-# LINE 60 "src-ag/CodeSyntaxDump.ag" #-}
                          ...
                          {-# LINE 526 "dist-ghc/build/CodeSyntaxDump" #-}
                          )
                 in  ( _lhsOpp)))
-- CSegments ---------------------------------------------------
{-
    ...
    (T_CSegments (let _lhsOppL :: ([PP_Doc])
                      ...
                      _lhsOppL =
                          ({-# LINE 98 "src-ag/CodeSyntaxDump.ag" #-}
                           _hdIpp : _tlIppL
                           {-# LINE 569 "dist-ghc/build/CodeSyntaxDump" #-}
                           )
                      -- use rule "src-ag/CodeSyntaxDump.ag"(line 44, column 40)
                      _lhsOpp =
                          ({-# LINE 44 "src-ag/CodeSyntaxDump.ag" #-}
                           _hdIpp >-< _tlIpp
                           {-# LINE 575 "dist-ghc/build/CodeSyntaxDump" #-}
                           )
                      ( _hdIpp) =
                          hd_
                      ( _tlIpp,_tlIppL) =
    ...
    (T_CSegments (let _lhsOppL :: ([PP_Doc])
                      ...
                      _lhsOppL =
                          ({-# LINE 99 "src-ag/CodeSyntaxDump.ag" #-}
                           []
                           {-# LINE 590 "dist-ghc/build/CodeSyntaxDump" #-}
                           )
                      -- use rule "src-ag/CodeSyntaxDump.ag"(line 44, column 40)
                      _lhsOpp =
                          ({-# LINE 44 "src-ag/CodeSyntaxDump.ag" #-}
                           empty
                           {-# LINE 596 "dist-ghc/build/CodeSyntaxDump" #-}
                           )
                  in  ( _lhsOpp,_lhsOppL)))
-- CVisit ------------------------------------------------------
{-
    ...
    (T_CVisit (let _lhsOpp :: PP_Doc
                   ...
                   _lhsOpp =
                       ({-# LINE 66 "src-ag/CodeSyntaxDump.ag" #-}
                        ...
                        {-# LINE 641 "dist-ghc/build/CodeSyntaxDump" #-}
                        )
                   ( _vssIppL) =
                       vss_
                   ( _intraIppL) =
    ...
    (T_CVisits (let _lhsOppL :: ([PP_Doc])
                    ...
                    _lhsOppL =
                        ({-# LINE 90 "src-ag/CodeSyntaxDump.ag" #-}
                         _hdIpp : _tlIppL
                         {-# LINE 688 "dist-ghc/build/CodeSyntaxDump" #-}
                         )
                    -- use rule "src-ag/CodeSyntaxDump.ag"(line 44, column 40)
                    _lhsOpp =
                        ({-# LINE 44 "src-ag/CodeSyntaxDump.ag" #-}
                         _hdIpp >-< _tlIpp
                         {-# LINE 694 "dist-ghc/build/CodeSyntaxDump" #-}
                         )
                    ( _hdIpp) =
                        hd_
                    ( _tlIpp,_tlIppL) =
    ...
    (T_CVisits (let _lhsOppL :: ([PP_Doc])
                    ...
                    _lhsOppL =
                        ({-# LINE 91 "src-ag/CodeSyntaxDump.ag" #-}
                         []
                         {-# LINE 709 "dist-ghc/build/CodeSyntaxDump" #-}
                         )
                    -- use rule "src-ag/CodeSyntaxDump.ag"(line 44, column 40)
                    _lhsOpp =
                        ({-# LINE 44 "src-ag/CodeSyntaxDump.ag" #-}
                         empty
                         {-# LINE 715 "dist-ghc/build/CodeSyntaxDump" #-}
                         )
                in  ( _lhsOpp,_lhsOppL)))
-- Pattern -----------------------------------------------------
{-
    ...
    (T_Pattern (let _lhsOpp :: PP_Doc
                    ...
                    _lhsOpp =
                        ({-# LINE 75 "src-ag/CodeSyntaxDump.ag" #-}
                         ...
                         {-# LINE 786 "dist-ghc/build/CodeSyntaxDump" #-}
                         )
                    -- self rule
                    _copy =
                        ({-# LINE 22 "src-ag/Patterns.ag" #-}
                         Alias field_ attr_ _patIcopy
                         {-# LINE 792 "dist-ghc/build/CodeSyntaxDump" #-}
                         )
                    -- self rule
                    _lhsOcopy =
                        ({-# LINE 22 "src-ag/Patterns.ag" #-}
                         _copy
                         {-# LINE 798 "dist-ghc/build/CodeSyntaxDump" #-}
                         )
                    ( _patIcopy,_patIpp) =
                        pat_
    ...
    (T_Pattern (let _lhsOpp :: PP_Doc
                    ...
                    _lhsOpp =
                        ({-# LINE 73 "src-ag/CodeSyntaxDump.ag" #-}
                         ...
                         {-# LINE 816 "dist-ghc/build/CodeSyntaxDump" #-}
                         )
                    -- self rule
                    _copy =
                        ({-# LINE 22 "src-ag/Patterns.ag" #-}
                         Constr name_ _patsIcopy
                         {-# LINE 822 "dist-ghc/build/CodeSyntaxDump" #-}
                         )
                    -- self rule
                    _lhsOcopy =
                        ({-# LINE 22 "src-ag/Patterns.ag" #-}
                         _copy
                         {-# LINE 828 "dist-ghc/build/CodeSyntaxDump" #-}
                         )
...
sem_Pattern_Irrefutable (T_Pattern pat_) =
    (T_Pattern (let _lhsOpp :: PP_Doc
                    ...
                    _lhsOpp =
                        ({-# LINE 44 "src-ag/CodeSyntaxDump.ag" #-}
                         _patIpp
                         {-# LINE 844 "dist-ghc/build/CodeSyntaxDump" #-}
                         )
                    -- self rule
                    _copy =
                        ({-# LINE 22 "src-ag/Patterns.ag" #-}
                         Irrefutable _patIcopy
                         {-# LINE 850 "dist-ghc/build/CodeSyntaxDump" #-}
                         )
                    -- self rule
                    _lhsOcopy =
                        ({-# LINE 22 "src-ag/Patterns.ag" #-}
                         _copy
                         {-# LINE 856 "dist-ghc/build/CodeSyntaxDump" #-}
                         )
                    ( _patIcopy,_patIpp) =
                        pat_
                in  ( _lhsOcopy,_lhsOpp)))
    ...
    (T_Pattern (let _lhsOpp :: PP_Doc
                    ...
                    _lhsOpp =
                        ({-# LINE 74 "src-ag/CodeSyntaxDump.ag" #-}
                         ...
                         {-# LINE 874 "dist-ghc/build/CodeSyntaxDump" #-}
                         )
                    -- self rule
                    _copy =
                        ({-# LINE 22 "src-ag/Patterns.ag" #-}
                         Product pos_ _patsIcopy
                         {-# LINE 880 "dist-ghc/build/CodeSyntaxDump" #-}
                         )
                    -- self rule
                    _lhsOcopy =
                        ({-# LINE 22 "src-ag/Patterns.ag" #-}
                         _copy
                         {-# LINE 886 "dist-ghc/build/CodeSyntaxDump" #-}
                         )
                    ( _patsIcopy,_patsIpp,_patsIppL) =
                        pats_
                in  ( _lhsOcopy,_lhsOpp)))
    ...
    (T_Pattern (let _lhsOpp :: PP_Doc
                    ...
                    _lhsOpp =
                        ({-# LINE 76 "src-ag/CodeSyntaxDump.ag" #-}
                         ...
                         {-# LINE 900 "dist-ghc/build/CodeSyntaxDump" #-}
                         )
                    -- self rule
                    _copy =
                        ({-# LINE 22 "src-ag/Patterns.ag" #-}
                         Underscore pos_
                         {-# LINE 906 "dist-ghc/build/CodeSyntaxDump" #-}
                         )
                    -- self rule
                    _lhsOcopy =
                        ({-# LINE 22 "src-ag/Patterns.ag" #-}
                         _copy
                         {-# LINE 912 "dist-ghc/build/CodeSyntaxDump" #-}
                         )
                in  ( _lhsOcopy,_lhsOpp)))
-- Patterns ----------------------------------------------------
{-
    ...
    (T_Patterns (let _lhsOppL :: ([PP_Doc])
                     ...
                     _lhsOppL =
                         ({-# LINE 82 "src-ag/CodeSyntaxDump.ag" #-}
                          _hdIpp : _tlIppL
                          {-# LINE 963 "dist-ghc/build/CodeSyntaxDump" #-}
                          )
                     -- use rule "src-ag/CodeSyntaxDump.ag"(line 44, column 40)
                     _lhsOpp =
                         ({-# LINE 44 "src-ag/CodeSyntaxDump.ag" #-}
                          _hdIpp >-< _tlIpp
                          {-# LINE 969 "dist-ghc/build/CodeSyntaxDump" #-}
                          )
                     -- self rule
                     _copy =
                         ({-# LINE 22 "src-ag/Patterns.ag" #-}
                          (:) _hdIcopy _tlIcopy
                          {-# LINE 975 "dist-ghc/build/CodeSyntaxDump" #-}
                          )
                     -- self rule
                     _lhsOcopy =
                         ({-# LINE 22 "src-ag/Patterns.ag" #-}
                          _copy
                          {-# LINE 981 "dist-ghc/build/CodeSyntaxDump" #-}
                          )
                     ( _hdIcopy,_hdIpp) =
                         hd_
    ...
    (T_Patterns (let _lhsOppL :: ([PP_Doc])
                     ...
                     _lhsOppL =
                         ({-# LINE 83 "src-ag/CodeSyntaxDump.ag" #-}
                          []
                          {-# LINE 997 "dist-ghc/build/CodeSyntaxDump" #-}
                          )
                     -- use rule "src-ag/CodeSyntaxDump.ag"(line 44, column 40)
                     _lhsOpp =
                         ({-# LINE 44 "src-ag/CodeSyntaxDump.ag" #-}
                          empty
                          {-# LINE 1003 "dist-ghc/build/CodeSyntaxDump" #-}
                          )
                     -- self rule
                     _copy =
                         ({-# LINE 22 "src-ag/Patterns.ag" #-}
                          []
                          {-# LINE 1009 "dist-ghc/build/CodeSyntaxDump" #-}
                          )
                     -- self rule
                     _lhsOcopy =
                         ({-# LINE 22 "src-ag/Patterns.ag" #-}
                          _copy
                          {-# LINE 1015 "dist-ghc/build/CodeSyntaxDump" #-}
                          )
                 in  ( _lhsOcopy,_lhsOpp,_lhsOppL)))
-- Sequence ----------------------------------------------------
{-
    ...
    (T_Sequence (let _lhsOppL :: ([PP_Doc])
                     ...
                     _lhsOppL =
                         ({-# LINE 86 "src-ag/CodeSyntaxDump.ag" #-}
                          _hdIpp : _tlIppL
                          {-# LINE 1055 "dist-ghc/build/CodeSyntaxDump" #-}
                          )
                     ( _hdIpp) =
                         hd_
                     ( _tlIppL) =
    ...
    (T_Sequence (let _lhsOppL :: ([PP_Doc])
                     ...
                     _lhsOppL =
                         ({-# LINE 87 "src-ag/CodeSyntaxDump.ag" #-}
                          []
                          {-# LINE 1069 "dist-ghc/build/CodeSyntaxDump" #-}
                          )
                 in  ( _lhsOppL)))