...
-- UUAGC 0.9.40.3 (src-ag/TfmToVisage.ag)
...
import Data.Map (Map)
{-# LINE 13 "dist-ghc/build/TfmToVisage.hs" #-}
...
{-# LINE 25 "dist-ghc/build/TfmToVisage.hs" #-}
...
{-# LINE 32 "dist-ghc/build/TfmToVisage.hs" #-}

{-# LINE 2 "src-ag/Expression.ag" #-}

import UU.Scanner.Position(Pos)
import HsToken
{-# LINE 38 "dist-ghc/build/TfmToVisage.hs" #-}
...
-}
{-# LINE 94 "dist-ghc/build/TfmToVisage.hs" #-}
-- Child -------------------------------------------------------
{-
   visit 0:
                  ...
                  (let _lhsOvchild :: VisageChild
                       ...
                       _lhsOvchild =
                           ({-# LINE 121 "src-ag/TfmToVisage.ag" #-}
                            ...
                            {-# LINE 145 "dist-ghc/build/TfmToVisage" #-}
                            )
                     ...
                     (let _lhsOvchildren :: ([VisageChild])
                          ...
                          _lhsOvchildren =
                              ({-# LINE 117 "src-ag/TfmToVisage.ag" #-}
                               ...
                               {-# LINE 222 "dist-ghc/build/TfmToVisage" #-}
                               )
                          -- copy rule (down)
                          _hdOinhMap =
                              ({-# LINE 12 "src-ag/DistChildAttr.ag" #-}
                               _lhsIinhMap
                               {-# LINE 228 "dist-ghc/build/TfmToVisage" #-}
                               )
                          -- copy rule (down)
                          _hdOrulemap =
                              ({-# LINE 83 "src-ag/TfmToVisage.ag" #-}
                               _lhsIrulemap
                               {-# LINE 234 "dist-ghc/build/TfmToVisage" #-}
                               )
                          -- copy rule (down)
                          _hdOsynMap =
                              ({-# LINE 12 "src-ag/DistChildAttr.ag" #-}
                               _lhsIsynMap
                               {-# LINE 240 "dist-ghc/build/TfmToVisage" #-}
                               )
                          -- copy rule (down)
                          _tlOinhMap =
                              ({-# LINE 12 "src-ag/DistChildAttr.ag" #-}
                               _lhsIinhMap
                               {-# LINE 246 "dist-ghc/build/TfmToVisage" #-}
                               )
                          -- copy rule (down)
                          _tlOrulemap =
                              ({-# LINE 84 "src-ag/TfmToVisage.ag" #-}
                               _lhsIrulemap
                               {-# LINE 252 "dist-ghc/build/TfmToVisage" #-}
                               )
                          -- copy rule (down)
                          _tlOsynMap =
                              ({-# LINE 12 "src-ag/DistChildAttr.ag" #-}
                               _lhsIsynMap
                               {-# LINE 258 "dist-ghc/build/TfmToVisage" #-}
                               )
                          ( _hdIvchild) =
                     ...
                     (let _lhsOvchildren :: ([VisageChild])
                          ...
                          _lhsOvchildren =
                              ({-# LINE 118 "src-ag/TfmToVisage.ag" #-}
                               []
                               {-# LINE 275 "dist-ghc/build/TfmToVisage" #-}
                               )
                      in  ( _lhsOvchildren))))
-- Expression --------------------------------------------------
{-
    ...
    (T_Expression (let _lhsOself :: Expression
                       ...
                       _self =
                           ({-# LINE 74 "src-ag/TfmToVisage.ag" #-}
                            ...
                            {-# LINE 314 "dist-ghc/build/TfmToVisage" #-}
                            )
                       -- self rule
                       _lhsOself =
                           ({-# LINE 74 "src-ag/TfmToVisage.ag" #-}
                            _self
                            {-# LINE 320 "dist-ghc/build/TfmToVisage" #-}
                            )
                   in  ( _lhsOself)))
-- Grammar -----------------------------------------------------
{-
    ...
    (T_Grammar (let _lhsOvisage :: VisageGrammar
                    ...
                    _lhsOvisage =
                        ({-# LINE 90 "src-ag/TfmToVisage.ag" #-}
                         ...
                         {-# LINE 386 "dist-ghc/build/TfmToVisage" #-}
                         )
                    -- "src-ag/DistChildAttr.ag"(line 15, column 13)
                    _nontsOinhMap =
                        ({-# LINE 15 "src-ag/DistChildAttr.ag" #-}
                         _nontsIinhMap'
                         {-# LINE 392 "dist-ghc/build/TfmToVisage" #-}
                         )
                    -- "src-ag/DistChildAttr.ag"(line 16, column 13)
                    _nontsOsynMap =
                        ({-# LINE 16 "src-ag/DistChildAttr.ag" #-}
                         _nontsIsynMap'
                         {-# LINE 398 "dist-ghc/build/TfmToVisage" #-}
                         )
                        ...
                        (let _lhsOvnont :: VisageNonterminal
                             ...
                             _lhsOvnont =
                                 ({-# LINE 100 "src-ag/TfmToVisage.ag" #-}
                                  ...
                                  {-# LINE 457 "dist-ghc/build/TfmToVisage" #-}
                                  )
                             -- "src-ag/DistChildAttr.ag"(line 7, column 18)
                             _lhsOinhMap' =
                                 ({-# LINE 7 "src-ag/DistChildAttr.ag" #-}
                                  Map.singleton nt_ inh_
                                  {-# LINE 463 "dist-ghc/build/TfmToVisage" #-}
                                  )
                             -- "src-ag/DistChildAttr.ag"(line 8, column 18)
                             _lhsOsynMap' =
                                 ({-# LINE 8 "src-ag/DistChildAttr.ag" #-}
                                  Map.singleton nt_ syn_
                                  {-# LINE 469 "dist-ghc/build/TfmToVisage" #-}
                                  )
                             -- copy rule (down)
                             _prodsOinhMap =
                                 ({-# LINE 12 "src-ag/DistChildAttr.ag" #-}
                                  _lhsIinhMap
                                  {-# LINE 475 "dist-ghc/build/TfmToVisage" #-}
                                  )
                             -- copy rule (down)
                             _prodsOsynMap =
                                 ({-# LINE 12 "src-ag/DistChildAttr.ag" #-}
                                  _lhsIsynMap
                                  {-# LINE 481 "dist-ghc/build/TfmToVisage" #-}
                                  )
                             ( _prodsIvprods) =
                         ...
                         (let _lhsOvnonts :: ([VisageNonterminal])
                              ...
                              _lhsOvnonts =
                                  ({-# LINE 94 "src-ag/TfmToVisage.ag" #-}
                                   ...
                                   {-# LINE 542 "dist-ghc/build/TfmToVisage" #-}
                                   )
                              -- use rule "src-ag/DistChildAttr.ag"(line 4, column 53)
                              _lhsOinhMap' =
                                  ({-# LINE 4 "src-ag/DistChildAttr.ag" #-}
                                   _hdIinhMap' `Map.union` _tlIinhMap'
                                   {-# LINE 548 "dist-ghc/build/TfmToVisage" #-}
                                   )
                              -- use rule "src-ag/DistChildAttr.ag"(line 4, column 53)
                              _lhsOsynMap' =
                                  ({-# LINE 4 "src-ag/DistChildAttr.ag" #-}
                                   _hdIsynMap' `Map.union` _tlIsynMap'
                                   {-# LINE 554 "dist-ghc/build/TfmToVisage" #-}
                                   )
                              -- copy rule (down)
                              _hdOinhMap =
                                  ({-# LINE 12 "src-ag/DistChildAttr.ag" #-}
                                   _lhsIinhMap
                                   {-# LINE 560 "dist-ghc/build/TfmToVisage" #-}
                                   )
                              -- copy rule (down)
                              _hdOsynMap =
                                  ({-# LINE 12 "src-ag/DistChildAttr.ag" #-}
                                   _lhsIsynMap
                                   {-# LINE 566 "dist-ghc/build/TfmToVisage" #-}
                                   )
                              -- copy rule (down)
                              _tlOinhMap =
                                  ({-# LINE 12 "src-ag/DistChildAttr.ag" #-}
                                   _lhsIinhMap
                                   {-# LINE 572 "dist-ghc/build/TfmToVisage" #-}
                                   )
                              -- copy rule (down)
                              _tlOsynMap =
                                  ({-# LINE 12 "src-ag/DistChildAttr.ag" #-}
                                   _lhsIsynMap
                                   {-# LINE 578 "dist-ghc/build/TfmToVisage" #-}
                                   )
                         ...
                         (let _lhsOvnonts :: ([VisageNonterminal])
                              ...
                              _lhsOvnonts =
                                  ({-# LINE 96 "src-ag/TfmToVisage.ag" #-}
                                   []
                                   {-# LINE 596 "dist-ghc/build/TfmToVisage" #-}
                                   )
                              -- use rule "src-ag/DistChildAttr.ag"(line 4, column 53)
                              _lhsOinhMap' =
                                  ({-# LINE 4 "src-ag/DistChildAttr.ag" #-}
                                   Map.empty
                                   {-# LINE 602 "dist-ghc/build/TfmToVisage" #-}
                                   )
                              -- use rule "src-ag/DistChildAttr.ag"(line 4, column 53)
                              _lhsOsynMap' =
                                  ({-# LINE 4 "src-ag/DistChildAttr.ag" #-}
                                   Map.empty
                                   {-# LINE 608 "dist-ghc/build/TfmToVisage" #-}
                                   )
                          in  ( _lhsOinhMap',_lhsOsynMap',_lhsOvnonts))))
-- Pattern -----------------------------------------------------
{-
    ...
    (T_Pattern (let _lhsOvpat :: VisagePattern
                    ...
                    _lhsOvpat =
                        ({-# LINE 138 "src-ag/TfmToVisage.ag" #-}
                         ...
                         {-# LINE 692 "dist-ghc/build/TfmToVisage" #-}
                         )
                    -- "src-ag/TfmToVisage.ag"(line 147, column 17)
                    _lhsOfieldattrs =
                        ({-# LINE 147 "src-ag/TfmToVisage.ag" #-}
                         [(field_, attr_)]
                         {-# LINE 698 "dist-ghc/build/TfmToVisage" #-}
                         )
                    -- self rule
                    _copy =
                        ({-# LINE 22 "src-ag/Patterns.ag" #-}
                         Alias field_ attr_ _patIcopy
                         {-# LINE 704 "dist-ghc/build/TfmToVisage" #-}
                         )
                    -- self rule
                    _self =
                        ({-# LINE 74 "src-ag/TfmToVisage.ag" #-}
                         Alias field_ attr_ _patIself
                         {-# LINE 710 "dist-ghc/build/TfmToVisage" #-}
                         )
                    -- self rule
                    _lhsOcopy =
                        ({-# LINE 22 "src-ag/Patterns.ag" #-}
                         _copy
                         {-# LINE 716 "dist-ghc/build/TfmToVisage" #-}
                         )
                    -- self rule
                    _lhsOself =
                        ({-# LINE 74 "src-ag/TfmToVisage.ag" #-}
                         _self
                         {-# LINE 722 "dist-ghc/build/TfmToVisage" #-}
                         )
    ...
    (T_Pattern (let _lhsOvpat :: VisagePattern
                    ...
                    _lhsOvpat =
                        ({-# LINE 136 "src-ag/TfmToVisage.ag" #-}
                         ...
                         {-# LINE 743 "dist-ghc/build/TfmToVisage" #-}
                         )
                    -- use rule "src-ag/TfmToVisage.ag"(line 144, column 43)
                    _lhsOfieldattrs =
                        ({-# LINE 144 "src-ag/TfmToVisage.ag" #-}
                         _patsIfieldattrs
                         {-# LINE 749 "dist-ghc/build/TfmToVisage" #-}
                         )
                    -- self rule
                    _copy =
                        ({-# LINE 22 "src-ag/Patterns.ag" #-}
                         Constr name_ _patsIcopy
                         {-# LINE 755 "dist-ghc/build/TfmToVisage" #-}
                         )
                    -- self rule
                    _self =
                        ({-# LINE 74 "src-ag/TfmToVisage.ag" #-}
                         Constr name_ _patsIself
                         {-# LINE 761 "dist-ghc/build/TfmToVisage" #-}
                         )
                    -- self rule
                    _lhsOcopy =
                        ({-# LINE 22 "src-ag/Patterns.ag" #-}
                         _copy
                         {-# LINE 767 "dist-ghc/build/TfmToVisage" #-}
                         )
                    -- self rule
                    _lhsOself =
                        ({-# LINE 74 "src-ag/TfmToVisage.ag" #-}
                         _self
                         {-# LINE 773 "dist-ghc/build/TfmToVisage" #-}
                         )
...
sem_Pattern_Irrefutable (T_Pattern pat_) =
    (T_Pattern (let _lhsOfieldattrs :: ( [(Identifier,Identifier)] )
                    ...
                    _lhsOfieldattrs =
                        ({-# LINE 144 "src-ag/TfmToVisage.ag" #-}
                         _patIfieldattrs
                         {-# LINE 793 "dist-ghc/build/TfmToVisage" #-}
                         )
                    -- self rule
                    _copy =
                        ({-# LINE 22 "src-ag/Patterns.ag" #-}
                         Irrefutable _patIcopy
                         {-# LINE 799 "dist-ghc/build/TfmToVisage" #-}
                         )
                    -- self rule
                    _self =
                        ({-# LINE 74 "src-ag/TfmToVisage.ag" #-}
                         Irrefutable _patIself
                         {-# LINE 805 "dist-ghc/build/TfmToVisage" #-}
                         )
                    -- self rule
                    _lhsOcopy =
                        ({-# LINE 22 "src-ag/Patterns.ag" #-}
                         _copy
                         {-# LINE 811 "dist-ghc/build/TfmToVisage" #-}
                         )
                    -- self rule
                    _lhsOself =
                        ({-# LINE 74 "src-ag/TfmToVisage.ag" #-}
                         _self
                         {-# LINE 817 "dist-ghc/build/TfmToVisage" #-}
                         )
                    -- copy rule (up)
                    _lhsOvpat =
                        ({-# LINE 85 "src-ag/TfmToVisage.ag" #-}
                         _patIvpat
                         {-# LINE 823 "dist-ghc/build/TfmToVisage" #-}
                         )
                    ( _patIcopy,_patIfieldattrs,_patIself,_patIvpat) =
                        pat_
                in  ( _lhsOcopy,_lhsOfieldattrs,_lhsOself,_lhsOvpat)))
    ...
    (T_Pattern (let _lhsOvpat :: VisagePattern
                    ...
                    _lhsOvpat =
                        ({-# LINE 137 "src-ag/TfmToVisage.ag" #-}
                         ...
                         {-# LINE 844 "dist-ghc/build/TfmToVisage" #-}
                         )
                    -- use rule "src-ag/TfmToVisage.ag"(line 144, column 43)
                    _lhsOfieldattrs =
                        ({-# LINE 144 "src-ag/TfmToVisage.ag" #-}
                         _patsIfieldattrs
                         {-# LINE 850 "dist-ghc/build/TfmToVisage" #-}
                         )
                    -- self rule
                    _copy =
                        ({-# LINE 22 "src-ag/Patterns.ag" #-}
                         Product pos_ _patsIcopy
                         {-# LINE 856 "dist-ghc/build/TfmToVisage" #-}
                         )
                    -- self rule
                    _self =
                        ({-# LINE 74 "src-ag/TfmToVisage.ag" #-}
                         Product pos_ _patsIself
                         {-# LINE 862 "dist-ghc/build/TfmToVisage" #-}
                         )
                    -- self rule
                    _lhsOcopy =
                        ({-# LINE 22 "src-ag/Patterns.ag" #-}
                         _copy
                         {-# LINE 868 "dist-ghc/build/TfmToVisage" #-}
                         )
                    -- self rule
                    _lhsOself =
                        ({-# LINE 74 "src-ag/TfmToVisage.ag" #-}
                         _self
                         {-# LINE 874 "dist-ghc/build/TfmToVisage" #-}
                         )
                    ( _patsIcopy,_patsIfieldattrs,_patsIself,_patsIvpats) =
                        pats_
                in  ( _lhsOcopy,_lhsOfieldattrs,_lhsOself,_lhsOvpat)))
    ...
    (T_Pattern (let _lhsOvpat :: VisagePattern
                    ...
                    _lhsOvpat =
                        ({-# LINE 141 "src-ag/TfmToVisage.ag" #-}
                         VUnderscore pos_
                         {-# LINE 890 "dist-ghc/build/TfmToVisage" #-}
                         )
                    -- use rule "src-ag/TfmToVisage.ag"(line 144, column 43)
                    _lhsOfieldattrs =
                        ({-# LINE 144 "src-ag/TfmToVisage.ag" #-}
                         []
                         {-# LINE 896 "dist-ghc/build/TfmToVisage" #-}
                         )
                    -- self rule
                    _copy =
                        ({-# LINE 22 "src-ag/Patterns.ag" #-}
                         Underscore pos_
                         {-# LINE 902 "dist-ghc/build/TfmToVisage" #-}
                         )
                    -- self rule
                    _self =
                        ({-# LINE 74 "src-ag/TfmToVisage.ag" #-}
                         Underscore pos_
                         {-# LINE 908 "dist-ghc/build/TfmToVisage" #-}
                         )
                    -- self rule
                    _lhsOcopy =
                        ({-# LINE 22 "src-ag/Patterns.ag" #-}
                         _copy
                         {-# LINE 914 "dist-ghc/build/TfmToVisage" #-}
                         )
                    -- self rule
                    _lhsOself =
                        ({-# LINE 74 "src-ag/TfmToVisage.ag" #-}
                         _self
                         {-# LINE 920 "dist-ghc/build/TfmToVisage" #-}
                         )
                in  ( _lhsOcopy,_lhsOfieldattrs,_lhsOself,_lhsOvpat)))
-- Patterns ----------------------------------------------------
{-
    ...
    (T_Patterns (let _lhsOvpats :: ([VisagePattern])
                     ...
                     _lhsOvpats =
                         ({-# LINE 132 "src-ag/TfmToVisage.ag" #-}
                          _hdIvpat : _tlIvpats
                          {-# LINE 978 "dist-ghc/build/TfmToVisage" #-}
                          )
                     -- use rule "src-ag/TfmToVisage.ag"(line 144, column 43)
                     _lhsOfieldattrs =
                         ({-# LINE 144 "src-ag/TfmToVisage.ag" #-}
                          _hdIfieldattrs  ++  _tlIfieldattrs
                          {-# LINE 984 "dist-ghc/build/TfmToVisage" #-}
                          )
                     -- self rule
                     _copy =
                         ({-# LINE 22 "src-ag/Patterns.ag" #-}
                          (:) _hdIcopy _tlIcopy
                          {-# LINE 990 "dist-ghc/build/TfmToVisage" #-}
                          )
                     -- self rule
                     _self =
                         ({-# LINE 74 "src-ag/TfmToVisage.ag" #-}
                          (:) _hdIself _tlIself
                          {-# LINE 996 "dist-ghc/build/TfmToVisage" #-}
                          )
                     -- self rule
                     _lhsOcopy =
                         ({-# LINE 22 "src-ag/Patterns.ag" #-}
                          _copy
                          {-# LINE 1002 "dist-ghc/build/TfmToVisage" #-}
                          )
                     -- self rule
                     _lhsOself =
                         ({-# LINE 74 "src-ag/TfmToVisage.ag" #-}
                          _self
                          {-# LINE 1008 "dist-ghc/build/TfmToVisage" #-}
                          )
    ...
    (T_Patterns (let _lhsOvpats :: ([VisagePattern])
                     ...
                     _lhsOvpats =
                         ({-# LINE 133 "src-ag/TfmToVisage.ag" #-}
                          []
                          {-# LINE 1025 "dist-ghc/build/TfmToVisage" #-}
                          )
                     -- use rule "src-ag/TfmToVisage.ag"(line 144, column 43)
                     _lhsOfieldattrs =
                         ({-# LINE 144 "src-ag/TfmToVisage.ag" #-}
                          []
                          {-# LINE 1031 "dist-ghc/build/TfmToVisage" #-}
                          )
                     -- self rule
                     _copy =
                         ({-# LINE 22 "src-ag/Patterns.ag" #-}
                          []
                          {-# LINE 1037 "dist-ghc/build/TfmToVisage" #-}
                          )
                     -- self rule
                     _self =
                         ({-# LINE 74 "src-ag/TfmToVisage.ag" #-}
                          []
                          {-# LINE 1043 "dist-ghc/build/TfmToVisage" #-}
                          )
                     -- self rule
                     _lhsOcopy =
                         ({-# LINE 22 "src-ag/Patterns.ag" #-}
                          _copy
                          {-# LINE 1049 "dist-ghc/build/TfmToVisage" #-}
                          )
                     -- self rule
                     _lhsOself =
                         ({-# LINE 74 "src-ag/TfmToVisage.ag" #-}
                          _self
                          {-# LINE 1055 "dist-ghc/build/TfmToVisage" #-}
                          )
                 in  ( _lhsOcopy,_lhsOfieldattrs,_lhsOself,_lhsOvpats)))
-- Production --------------------------------------------------
{-
                        ...
                        (let _lhsOvprods :: ([VisageProduction])
                             ...
                             _lhsOvprods =
                                 ({-# LINE 104 "src-ag/TfmToVisage.ag" #-}
                                  ...
                                  {-# LINE 1209 "dist-ghc/build/TfmToVisage" #-}
                                  )
                             -- copy rule (down)
                             _hdOinhMap =
                                 ({-# LINE 12 "src-ag/DistChildAttr.ag" #-}
                                  _lhsIinhMap
                                  {-# LINE 1215 "dist-ghc/build/TfmToVisage" #-}
                                  )
                             -- copy rule (down)
                             _hdOsynMap =
                                 ({-# LINE 12 "src-ag/DistChildAttr.ag" #-}
                                  _lhsIsynMap
                                  {-# LINE 1221 "dist-ghc/build/TfmToVisage" #-}
                                  )
                             -- copy rule (down)
                             _tlOinhMap =
                                 ({-# LINE 12 "src-ag/DistChildAttr.ag" #-}
                                  _lhsIinhMap
                                  {-# LINE 1227 "dist-ghc/build/TfmToVisage" #-}
                                  )
                             -- copy rule (down)
                             _tlOsynMap =
                                 ({-# LINE 12 "src-ag/DistChildAttr.ag" #-}
                                  _lhsIsynMap
                                  {-# LINE 1233 "dist-ghc/build/TfmToVisage" #-}
                                  )
                             ( _hdIvprod) =
                                 hd_ _hdOinhMap _hdOsynMap
                             ( _tlIvprods) =
                        ...
                        (let _lhsOvprods :: ([VisageProduction])
                             ...
                             _lhsOvprods =
                                 ({-# LINE 106 "src-ag/TfmToVisage.ag" #-}
                                  []
                                  {-# LINE 1249 "dist-ghc/build/TfmToVisage" #-}
                                  )
                         in  ( _lhsOvprods))))
-- Rule --------------------------------------------------------
{-
    ...
    (T_Rule (let _lhsOvrule :: VisageRule
                 ...
                 _lhsOvrule =
                     ({-# LINE 129 "src-ag/TfmToVisage.ag" #-}
                      ...
                      {-# LINE 1307 "dist-ghc/build/TfmToVisage" #-}
                      )
    ...
    (T_Rules (let _lhsOvrules :: ([VisageRule])
                  ...
                  _lhsOvrules =
                      ({-# LINE 124 "src-ag/TfmToVisage.ag" #-}
                       ...
                       {-# LINE 1351 "dist-ghc/build/TfmToVisage" #-}
                       )
                  ( _hdIvrule) =
                      hd_
                  ( _tlIvrules) =
    ...
    (T_Rules (let _lhsOvrules :: ([VisageRule])
                  ...
                  _lhsOvrules =
                      ({-# LINE 125 "src-ag/TfmToVisage.ag" #-}
                       []
                       {-# LINE 1365 "dist-ghc/build/TfmToVisage" #-}
                       )
              in  ( _lhsOvrules)))
-- TypeSig -----------------------------------------------------
{-
