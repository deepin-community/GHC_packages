    ...
    (T_Pattern (let _lhsOpp :: PP_Doc
                    ...
                    _lhsOpp =
                        ({-# LINE 46 "src-ag/AbstractSyntaxDump.ag" #-}
                         ...
                         {-# LINE 444 "dist-ghc/build/AbstractSyntaxDump" #-}
                         )
                    -- self rule
                    _copy =
                        ({-# LINE 22 "src-ag/Patterns.ag" #-}
                         Alias field_ attr_ _patIcopy
                         {-# LINE 450 "dist-ghc/build/AbstractSyntaxDump" #-}
                         )
                    -- self rule
                    _lhsOcopy =
                        ({-# LINE 22 "src-ag/Patterns.ag" #-}
                         _copy
                         {-# LINE 456 "dist-ghc/build/AbstractSyntaxDump" #-}
                         )
                    ( _patIcopy,_patIpp) =
                        pat_
    ...
    (T_Pattern (let _lhsOpp :: PP_Doc
                    ...
                    _lhsOpp =
                        ({-# LINE 44 "src-ag/AbstractSyntaxDump.ag" #-}
                         ...
                         {-# LINE 474 "dist-ghc/build/AbstractSyntaxDump" #-}
                         )
                    -- self rule
                    _copy =
                        ({-# LINE 22 "src-ag/Patterns.ag" #-}
                         Constr name_ _patsIcopy
                         {-# LINE 480 "dist-ghc/build/AbstractSyntaxDump" #-}
                         )
                    -- self rule
                    _lhsOcopy =
                        ({-# LINE 22 "src-ag/Patterns.ag" #-}
                         _copy
                         {-# LINE 486 "dist-ghc/build/AbstractSyntaxDump" #-}
                         )
...
sem_Pattern_Irrefutable (T_Pattern pat_) =
    (T_Pattern (let _lhsOpp :: PP_Doc
                    ...
                    _lhsOpp =
                        ({-# LINE 17 "src-ag/AbstractSyntaxDump.ag" #-}
                         _patIpp
                         {-# LINE 502 "dist-ghc/build/AbstractSyntaxDump" #-}
                         )
                    -- self rule
                    _copy =
                        ({-# LINE 22 "src-ag/Patterns.ag" #-}
                         Irrefutable _patIcopy
                         {-# LINE 508 "dist-ghc/build/AbstractSyntaxDump" #-}
                         )
                    -- self rule
                    _lhsOcopy =
                        ({-# LINE 22 "src-ag/Patterns.ag" #-}
                         _copy
                         {-# LINE 514 "dist-ghc/build/AbstractSyntaxDump" #-}
                         )
                    ( _patIcopy,_patIpp) =
                        pat_
                in  ( _lhsOcopy,_lhsOpp)))
    ...
    (T_Pattern (let _lhsOpp :: PP_Doc
                    ...
                    _lhsOpp =
                        ({-# LINE 45 "src-ag/AbstractSyntaxDump.ag" #-}
                         ...
                         {-# LINE 532 "dist-ghc/build/AbstractSyntaxDump" #-}
                         )
                    -- self rule
                    _copy =
                        ({-# LINE 22 "src-ag/Patterns.ag" #-}
                         Product pos_ _patsIcopy
                         {-# LINE 538 "dist-ghc/build/AbstractSyntaxDump" #-}
                         )
                    -- self rule
                    _lhsOcopy =
                        ({-# LINE 22 "src-ag/Patterns.ag" #-}
                         _copy
                         {-# LINE 544 "dist-ghc/build/AbstractSyntaxDump" #-}
                         )
                    ( _patsIcopy,_patsIpp,_patsIppL) =
                        pats_
                in  ( _lhsOcopy,_lhsOpp)))
    ...
    (T_Pattern (let _lhsOpp :: PP_Doc
                    ...
                    _lhsOpp =
                        ({-# LINE 47 "src-ag/AbstractSyntaxDump.ag" #-}
                         ...
                         {-# LINE 558 "dist-ghc/build/AbstractSyntaxDump" #-}
                         )
                    -- self rule
                    _copy =
                        ({-# LINE 22 "src-ag/Patterns.ag" #-}
                         Underscore pos_
                         {-# LINE 564 "dist-ghc/build/AbstractSyntaxDump" #-}
                         )
                    -- self rule
                    _lhsOcopy =
                        ({-# LINE 22 "src-ag/Patterns.ag" #-}
                         _copy
                         {-# LINE 570 "dist-ghc/build/AbstractSyntaxDump" #-}
                         )
                in  ( _lhsOcopy,_lhsOpp)))
-- Patterns ----------------------------------------------------
{-
    ...
    (T_Patterns (let _lhsOppL :: ([PP_Doc])
                     ...
                     _lhsOppL =
                         ({-# LINE 55 "src-ag/AbstractSyntaxDump.ag" #-}
                          _hdIpp : _tlIppL
                          {-# LINE 621 "dist-ghc/build/AbstractSyntaxDump" #-}
                          )
                     -- use rule "src-ag/AbstractSyntaxDump.ag"(line 17, column 58)
                     _lhsOpp =
                         ({-# LINE 17 "src-ag/AbstractSyntaxDump.ag" #-}
                          _hdIpp >-< _tlIpp
                          {-# LINE 627 "dist-ghc/build/AbstractSyntaxDump" #-}
                          )
                     -- self rule
                     _copy =
                         ({-# LINE 22 "src-ag/Patterns.ag" #-}
                          (:) _hdIcopy _tlIcopy
                          {-# LINE 633 "dist-ghc/build/AbstractSyntaxDump" #-}
                          )
                     -- self rule
                     _lhsOcopy =
                         ({-# LINE 22 "src-ag/Patterns.ag" #-}
                          _copy
                          {-# LINE 639 "dist-ghc/build/AbstractSyntaxDump" #-}
                          )
                     ( _hdIcopy,_hdIpp) =
                         hd_
    ...
    (T_Patterns (let _lhsOppL :: ([PP_Doc])
                     ...
                     _lhsOppL =
                         ({-# LINE 56 "src-ag/AbstractSyntaxDump.ag" #-}
                          []
                          {-# LINE 655 "dist-ghc/build/AbstractSyntaxDump" #-}
                          )
                     -- use rule "src-ag/AbstractSyntaxDump.ag"(line 17, column 58)
                     _lhsOpp =
                         ({-# LINE 17 "src-ag/AbstractSyntaxDump.ag" #-}
                          empty
                          {-# LINE 661 "dist-ghc/build/AbstractSyntaxDump" #-}
                          )
                     -- self rule
                     _copy =
                         ({-# LINE 22 "src-ag/Patterns.ag" #-}
                          []
                          {-# LINE 667 "dist-ghc/build/AbstractSyntaxDump" #-}
                          )
                     -- self rule
                     _lhsOcopy =
                         ({-# LINE 22 "src-ag/Patterns.ag" #-}
                          _copy
                          {-# LINE 673 "dist-ghc/build/AbstractSyntaxDump" #-}
                          )
                 in  ( _lhsOcopy,_lhsOpp,_lhsOppL)))
-- Production --------------------------------------------------
{-
    ...
    (T_Production (let _lhsOpp :: PP_Doc
                       ...
                       _lhsOpp =
                           ({-# LINE 32 "src-ag/AbstractSyntaxDump.ag" #-}
                            ...
                            {-# LINE 726 "dist-ghc/build/AbstractSyntaxDump" #-}
                            )
    ...
    (T_Productions (let _lhsOppL :: ([PP_Doc])
                        ...
                        _lhsOppL =
                            ({-# LINE 71 "src-ag/AbstractSyntaxDump.ag" #-}
                             _hdIpp : _tlIppL
                             {-# LINE 775 "dist-ghc/build/AbstractSyntaxDump" #-}
                             )
                        -- use rule "src-ag/AbstractSyntaxDump.ag"(line 17, column 58)
                        _lhsOpp =
                            ({-# LINE 17 "src-ag/AbstractSyntaxDump.ag" #-}
                             _hdIpp >-< _tlIpp
                             {-# LINE 781 "dist-ghc/build/AbstractSyntaxDump" #-}
                             )
                        ( _hdIpp) =
                            hd_
                        ( _tlIpp,_tlIppL) =
    ...
    (T_Productions (let _lhsOppL :: ([PP_Doc])
                        ...
                        _lhsOppL =
                            ({-# LINE 72 "src-ag/AbstractSyntaxDump.ag" #-}
                             []
                             {-# LINE 796 "dist-ghc/build/AbstractSyntaxDump" #-}
                             )
                        -- use rule "src-ag/AbstractSyntaxDump.ag"(line 17, column 58)
                        _lhsOpp =
                            ({-# LINE 17 "src-ag/AbstractSyntaxDump.ag" #-}
                             empty
                             {-# LINE 802 "dist-ghc/build/AbstractSyntaxDump" #-}
                             )
                    in  ( _lhsOpp,_lhsOppL)))
-- Rule --------------------------------------------------------
{-
    ...
    (T_Rule (let _lhsOpp :: PP_Doc
                 ...
                 _lhsOpp =
                     ({-# LINE 38 "src-ag/AbstractSyntaxDump.ag" #-}
                      ...
                      {-# LINE 858 "dist-ghc/build/AbstractSyntaxDump" #-}
                      )
    ...
    (T_Rules (let _lhsOppL :: ([PP_Doc])
                  ...
                  _lhsOppL =
                      ({-# LINE 63 "src-ag/AbstractSyntaxDump.ag" #-}
                       _hdIpp : _tlIppL
                       {-# LINE 905 "dist-ghc/build/AbstractSyntaxDump" #-}
                       )
                  -- use rule "src-ag/AbstractSyntaxDump.ag"(line 17, column 58)
                  _lhsOpp =
                      ({-# LINE 17 "src-ag/AbstractSyntaxDump.ag" #-}
                       _hdIpp >-< _tlIpp
                       {-# LINE 911 "dist-ghc/build/AbstractSyntaxDump" #-}
                       )
                  ( _hdIpp) =
                      hd_
                  ( _tlIpp,_tlIppL) =
    ...
    (T_Rules (let _lhsOppL :: ([PP_Doc])
                  ...
                  _lhsOppL =
                      ({-# LINE 64 "src-ag/AbstractSyntaxDump.ag" #-}
                       []
                       {-# LINE 926 "dist-ghc/build/AbstractSyntaxDump" #-}
                       )
                  -- use rule "src-ag/AbstractSyntaxDump.ag"(line 17, column 58)
                  _lhsOpp =
                      ({-# LINE 17 "src-ag/AbstractSyntaxDump.ag" #-}
                       empty
                       {-# LINE 932 "dist-ghc/build/AbstractSyntaxDump" #-}
                       )
              in  ( _lhsOpp,_lhsOppL)))
-- TypeSig -----------------------------------------------------
{-
    ...
    (T_TypeSig (let _lhsOpp :: PP_Doc
                    ...
                    _lhsOpp =
                        ({-# LINE 41 "src-ag/AbstractSyntaxDump.ag" #-}
                         ...
                         {-# LINE 969 "dist-ghc/build/AbstractSyntaxDump" #-}
                         )
                in  ( _lhsOpp)))
-- TypeSigs ----------------------------------------------------
{-
    ...
    (T_TypeSigs (let _lhsOppL :: ([PP_Doc])
                     ...
                     _lhsOppL =
                         ({-# LINE 59 "src-ag/AbstractSyntaxDump.ag" #-}
                          _hdIpp : _tlIppL
                          {-# LINE 1012 "dist-ghc/build/AbstractSyntaxDump" #-}
                          )
                     -- use rule "src-ag/AbstractSyntaxDump.ag"(line 17, column 58)
                     _lhsOpp =
                         ({-# LINE 17 "src-ag/AbstractSyntaxDump.ag" #-}
                          _hdIpp >-< _tlIpp
                          {-# LINE 1018 "dist-ghc/build/AbstractSyntaxDump" #-}
                          )
                     ( _hdIpp) =
                         hd_
                     ( _tlIpp,_tlIppL) =
    ...
    (T_TypeSigs (let _lhsOppL :: ([PP_Doc])
                     ...
                     _lhsOppL =
                         ({-# LINE 60 "src-ag/AbstractSyntaxDump.ag" #-}
                          []
                          {-# LINE 1033 "dist-ghc/build/AbstractSyntaxDump" #-}
                          )
                     -- use rule "src-ag/AbstractSyntaxDump.ag"(line 17, column 58)
                     _lhsOpp =
                         ({-# LINE 17 "src-ag/AbstractSyntaxDump.ag" #-}
                          empty
                          {-# LINE 1039 "dist-ghc/build/AbstractSyntaxDump" #-}
                          )
                 in  ( _lhsOpp,_lhsOppL)))