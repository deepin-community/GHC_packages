...
-- UUAGC 0.9.40.3 (src-ag/PrintVisitCode.ag)
...
{-# LINE 27 "dist-ghc/build/PrintVisitCode.hs" #-}
...
import Data.Map(Map)
import Data.Set(Set)
{-# LINE 35 "dist-ghc/build/PrintVisitCode.hs" #-}
...
{-# LINE 42 "dist-ghc/build/PrintVisitCode.hs" #-}

{-# LINE 2 "src-ag/DeclBlocks.ag" #-}

import Code (Decl,Expr)
{-# LINE 47 "dist-ghc/build/PrintVisitCode.hs" #-}
...
{-# LINE 61 "dist-ghc/build/PrintVisitCode.hs" #-}
-- CGrammar ----------------------------------------------------
{-
   visit 0:
      inherited attribute:
...
sem_CGrammar_CGrammar typeSyns_ derivings_ wrappers_ (T_CNonterminals nonts_) pragmas_ paramMap_ contextMap_ quantMap_ aroundsMap_ mergeMap_ multivisit_ =
    (T_CGrammar (\ _lhsIoptions ->
                     (case (({-# LINE 53 "src-ag/PrintVisitCode.ag" #-}
                             []
                             {-# LINE 115 "dist-ghc/build/PrintVisitCode" #-}
                             )) of
                      { _lhsOoutput ->
                      ( _lhsOoutput) })))
-- CInterface --------------------------------------------------
    ...
    (T_Pattern (case (pat_) of
                { ( _patIcopy) ->
                    (case (({-# LINE 22 "src-ag/Patterns.ag" #-}
                            ...
                            {-# LINE 594 "dist-ghc/build/PrintVisitCode" #-}
                            )) of
                     { _copy ->
                     (case (({-# LINE 22 "src-ag/Patterns.ag" #-}
                             _copy
                             {-# LINE 599 "dist-ghc/build/PrintVisitCode" #-}
                             )) of
                      { _lhsOcopy ->
                      ( _lhsOcopy) }) }) }))
    ...
    (T_Pattern (case (pats_) of
                { ( _patsIcopy) ->
                    (case (({-# LINE 22 "src-ag/Patterns.ag" #-}
                            ...
                            {-# LINE 611 "dist-ghc/build/PrintVisitCode" #-}
                            )) of
                     { _copy ->
                     (case (({-# LINE 22 "src-ag/Patterns.ag" #-}
                             _copy
                             {-# LINE 616 "dist-ghc/build/PrintVisitCode" #-}
                             )) of
                      { _lhsOcopy ->
                      ( _lhsOcopy) }) }) }))
    ...
    (T_Pattern (case (pat_) of
                { ( _patIcopy) ->
                    (case (({-# LINE 22 "src-ag/Patterns.ag" #-}
                            ...
                            {-# LINE 627 "dist-ghc/build/PrintVisitCode" #-}
                            )) of
                     { _copy ->
                     (case (({-# LINE 22 "src-ag/Patterns.ag" #-}
                             _copy
                             {-# LINE 632 "dist-ghc/build/PrintVisitCode" #-}
                             )) of
                      { _lhsOcopy ->
                      ( _lhsOcopy) }) }) }))
    ...
    (T_Pattern (case (pats_) of
                { ( _patsIcopy) ->
                    (case (({-# LINE 22 "src-ag/Patterns.ag" #-}
                            ...
                            {-# LINE 644 "dist-ghc/build/PrintVisitCode" #-}
                            )) of
                     { _copy ->
                     (case (({-# LINE 22 "src-ag/Patterns.ag" #-}
                             _copy
                             {-# LINE 649 "dist-ghc/build/PrintVisitCode" #-}
                             )) of
                      { _lhsOcopy ->
                      ( _lhsOcopy) }) }) }))
...
sem_Pattern_Underscore pos_ =
    (T_Pattern (case (({-# LINE 22 "src-ag/Patterns.ag" #-}
                       Underscore pos_
                       {-# LINE 658 "dist-ghc/build/PrintVisitCode" #-}
                       )) of
                { _copy ->
                (case (({-# LINE 22 "src-ag/Patterns.ag" #-}
                        _copy
                        {-# LINE 663 "dist-ghc/build/PrintVisitCode" #-}
                        )) of
                 { _lhsOcopy ->
                 ( _lhsOcopy) }) }))
-- Patterns ----------------------------------------------------
                 ...
                 { ( _tlIcopy) ->
                     (case (hd_) of
                      { ( _hdIcopy) ->
                          (case (({-# LINE 22 "src-ag/Patterns.ag" #-}
                                  (:) _hdIcopy _tlIcopy
                                  {-# LINE 707 "dist-ghc/build/PrintVisitCode" #-}
                                  )) of
                           { _copy ->
                           (case (({-# LINE 22 "src-ag/Patterns.ag" #-}
                                   _copy
                                   {-# LINE 712 "dist-ghc/build/PrintVisitCode" #-}
                                   )) of
                            { _lhsOcopy ->
                            ( _lhsOcopy) }) }) }) }))
...
sem_Patterns_Nil =
    (T_Patterns (case (({-# LINE 22 "src-ag/Patterns.ag" #-}
                        []
                        {-# LINE 720 "dist-ghc/build/PrintVisitCode" #-}
                        )) of
                 { _copy ->
                 (case (({-# LINE 22 "src-ag/Patterns.ag" #-}
                         _copy
                         {-# LINE 725 "dist-ghc/build/PrintVisitCode" #-}
                         )) of
                  { _lhsOcopy ->
                  ( _lhsOcopy) }) }))
-- Sequence ----------------------------------------------------
